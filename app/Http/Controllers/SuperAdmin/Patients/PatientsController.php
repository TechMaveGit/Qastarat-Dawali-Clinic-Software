...
class PatientsController extends Controller
{
    ...
    public function addCreate(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'mobile_no' => 'nullable|numeric|unique:users,mobile_no|regex:/^[0-9]{7,13}$/',
            'password' => 'nullable',
            'name' => 'required',
            'gendar' => 'required',
            'title' => 'required',
        ...
        $patient['password'] = $request->password ? Hash::make($request->input('password')) : null;
        $patient['email'] = $request->input('password', null);
        $patient['mobile_no'] = $request->input('mobile_no', null);
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (request()->isMethod("post")) {
            ...
            if ($request->has('password') && isset($request->password)) {
                ...
                $patient['password'] = $data['userDetail']->password ?? null;
            }
