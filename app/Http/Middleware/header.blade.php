			...
			<header id="header" class="tra-menu navbar-dark light-hero-header white-scroll">
				...
				<div class="header-wrapper">
				    ...
				    <div class="wsmobileheader clearfix">	  	
				    	...
				    	<span class="smllogo"><img src="{{ url('//assets') }}/images/new-images/qastrat-logo2.png" alt="mobile-logo"></span>
	    				...
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						...
	    						<a href="{{ route('front.home.page') }}" class="logo-black">
	    							...
	    							<img class="light-theme-img" src="{{ url('//assets') }}/images/new-images/qastrat-logo2.png" alt="logo">

	    							<img class="dark-theme-img" src="{{ url('//assets') }}/images/new-images/qastrat-logo2.png" alt="logo">
	    					...
	    					<!-- <div class="desktoplogo">
	    						...
	    						<a href="#hero-15" class="logo-white"><img src="{{ url('//assets') }}/images/new-images/qastrat-logo2.png" alt="logo"></a>
