		...
		<div class="row">
			...
			<div class="col-xl-3">
				<div class="footer-info mb-0">
					<img class="footer-logo" src="images/new-images/qastrat-logo2.png" alt="footer-logo">
					<img class="footer-logo-dark" src="images/new-images/qastrat-logo2.png" alt="footer-logo">
				</div>
				...
				<div class="footer-links fl-3">
					...
					<ul class="foo-links clearfix address_ul">
						<li><i class="fa-solid fa-location-dot"></i>
							<p><a href="#">Sandal Pugnies,Wakefield (UK).</a></p>
						</li>
						<li><i class="fa-solid fa-envelope"></i>
							<p><a href="#">example@gmail.com</a></p>
						</li>
						<li><i class="fa-solid fa-phone"></i>
							<p><a href="#">+91-890-239-2345</a></p>
						</li>
				...
				<div class="row">
					...
					<div class="col-lg-12">
					  <div class="mt-2 form-group">
						...
						<div class="mt-3 form-group">
									<!-- <label for="validationCustom01" class="form-label">Write Summary</label> -->
									<textarea class="form-control" placeholder="Write Summary" style="height:100px"></textarea>
								</div>
...
<!----------------------------
  Annotate Image
---------------------------->
<div class="modal fade edit_patient__" id="annotate_image" tabindex="-1" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title" id="exampleModalLabel"> Annotate Image</h1>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i
						class="fa-solid fa-xmark"></i></button>
			</div>
			<div class="modal-body padding-0">
					...
					<div class="col-lg-12 mb-2">
                     ...
                     <div class="col-lg-12 ">
						<h6 class="question_title">Conservative - Topical Riparil</h6>
                                ...
                                <div class="col-lg-12" id="eligibile1_textarea">
                     ...
                     <div class="col-lg-12">
						<h6 class="question_title">Conservative - Topical Analgesics</h6>
                                ...
                                <div class="col-lg-12" id="eligibile2_textarea">
                                    <div class="form-check form-check-right mb-3 ps-0">
                                      <textarea class="form-control" placeholder="Enter Elaborate / notes here***"  style="height: 100px"></textarea>
                                    </div>
                                </div>
                     ...
                     <div class="col-lg-12">
						<h6 class="question_title">Conservative - PO Analgesics</h6>
                                ...
                                <div class="col-lg-12" id="eligibile3_textarea">
                                    <div class="form-check form-check-right mb-3 ps-0">
                                      <textarea class="form-control" placeholder="Enter Elaborate / notes here***"  style="height: 100px"></textarea>
                                    </div>
                                </div>
                     ...
                     <div class="col-lg-12">
						<h6 class="question_title">Conservative - Glucasamine / Chondroitin</h6>
                                ...
                                <div class="col-lg-12" id="eligibile4_textarea">
                                    <div class="form-check form-check-right mb-3 ps-0">
                                      <textarea class="form-control" placeholder="Enter Elaborate / notes here***"  style="height: 100px"></textarea>
                                    </div>
                                </div>
                     ...
                     <div class="col-lg-12">
						<h6 class="question_title">Conservative - PO - Collagen</h6>
                                ...
                                <div class="col-lg-12" id="eligibile5_textarea">
                                    <div class="form-check form-check-right mb-3 ps-0">
                                      <textarea class="form-control" placeholder="Enter Elaborate / notes here***"  style="height: 100px"></textarea>
                                    </div>
                                </div>
                     ...
                     <div class="col-lg-12">
						<h6 class="question_title">Conservative - IV Vitamins</h6>
                                ...
                                <div class="col-lg-12" id="eligibile6_textarea">
                                    <div class="form-check form-check-right mb-3 ps-0">
                                      <textarea class="form-control" placeholder="Enter Elaborate / notes here***"  style="height: 100px"></textarea>
                                    </div>
                                </div>
                     ...
                     <div class="col-lg-12">
						<h6 class="question_title">Conservative - IM Nurobion</h6>
                                ...
                                <div class="col-lg-12" id="eligibile7_textarea">
                                    <div class="form-check form-check-right mb-3 ps-0">
                                      <textarea class="form-control" placeholder="Enter Elaborate / notes here***"  style="height: 100px"></textarea>
                                    </div>
                                </div>
                     ...
                     <div class="col-lg-12">
						<h6 class="question_title">Conservative - IM Collagen</h6>
                                ...
                                <div class="col-lg-12" id="eligibile8_textarea">
                                    <div class="form-check form-check-right mb-3 ps-0">
                                      <textarea class="form-control" placeholder="Enter Elaborate / notes here***"  style="height: 100px"></textarea>
                                    </div>
                                </div>
			...
			<div class="modal-body padding-0">
				...
				<div class="inner_element">
					...
					<label for="validationCustom01" class="form-label">Select Procedure</label>
						<select class="form-control select2_procedure">
							<option value="">Consent Form</option>
							<option value="">Pre-Procedure Order</option>
							<option value="">Procedure Record</option>
							<option value="">Discharge Order</option>
				...
				<div class="inner_data">
					...
					<label class="w-100">
					  ...
					  <div class="form_box card-input">
							<div class="form_img">
                               <img src="images/new-images/forms.png" alt="">
							</div>
							<div class="form_dt">
			...
			<tr>
				<td>
					<div class="d-flex document pt-2">
						<img src="images/new-images/documents.png" class="avatar rounded me-3" alt="shreyu">
...
<!-- iconify icons js -->
<script src="js/iconify-icons.js"></script>
...
<script>
        ...
        imageObj.src = 'images/new-images/nodules.png';
