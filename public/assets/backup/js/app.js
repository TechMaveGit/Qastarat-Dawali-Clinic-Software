! function (n) {
    ...
    function t(e) {
        1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (n("html").removeAttr("dir"), n("#dark-mode-switch").prop("checked", !1), n("#rtl-mode-switch").prop("checked", !1), n("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"), n("#app-style").attr("href", "assets/css/app.min.css"), document.documentElement.setAttribute("data-bs-theme", "light"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == n("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (n("html").removeAttr("dir"), n("#light-mode-switch").prop("checked", !1), n("#rtl-mode-switch").prop("checked", !1), n("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"), n("#app-style").attr("href", "assets/css/app.min.css"), document.documentElement.setAttribute("data-bs-theme", "dark"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == n("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (n("#light-mode-switch").prop("checked", !1), n("#dark-mode-switch").prop("checked", !1), n("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css"), n("#app-style").attr("href", "assets/css/app-rtl.min.css"), n("html").attr("dir", "rtl"), document.documentElement.setAttribute("data-bs-theme", "light"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
    ...
    n("#side-menu").metisMenu(), n(".vertical-menu-btn").on("click", function (e) {
            ...
            var e;
            0 < n("#sidebar-menu").length && 0 < n("#sidebar-menu .mm-active .active").length && (300 < (e = n("#sidebar-menu .mm-active .active").offset().top) && (e -= 200, n(".vertical-menu .simplebar-content-wrapper").animate({
                scrollTop: e
            }, "slow")))
        ...
        function () {
            ...
            var e = document.querySelectorAll(".select-dropdown");
            e && e.forEach(function (t) {
                t.querySelectorAll(".dropdown-menu .dropdown-item").forEach(function (e) {
                    e.addEventListener("click", function () {
                        t.querySelector(".user-name-text").innerHTML = e.querySelector(".dropdown-name").innerHTML, t.querySelector(".user-sort-name").innerHTML = e.querySelector(".dropdown-sort-name").innerHTML, t.querySelector(".user-name-sub-text").innerHTML = e.querySelector(".dropdown-sub-desc").innerHTML
                    })
                })
            })
        }(), n(window).on("load", function () {
            n("#status").fadeOut(), n("#preloader").delay(350).fadeOut("slow")
        }), window.sessionStorage && ((r = sessionStorage.getItem("is_visited")) ? (n(".right-bar input:checkbox").prop("checked", !1), n("#" + r).prop("checked", !0), t(r)) : "dark" == document.documentElement.getAttribute("data-bs-theme") ? (sessionStorage.setItem("is_visited", "dark-mode-switch"), n("#light-mode-switch").prop("checked", !1), n("#dark-mode-switch").prop("checked", !0), n("#rtl-mode-switch").prop("checked", !1)) : "light" != document.documentElement.getAttribute("data-bs-theme") && "rtl" == document.documentElement.getAttribute("dir") ? (sessionStorage.setItem("is_visited", "rtl-mode-switch"), n("#light-mode-switch").prop("checked", !1), n("#dark-mode-switch").prop("checked", !1), n("#rtl-mode-switch").prop("checked", !0)) : sessionStorage.setItem("is_visited", "light-mode-switch")), n("#light-mode-switch, #dark-mode-switch, #rtl-mode-switch").on("change", function (e) {
            t(e.target.id)
        }), Waves.init()
}(jQuery);