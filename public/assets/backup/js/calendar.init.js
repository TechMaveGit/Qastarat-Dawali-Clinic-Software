! function (g) {
    ...
    e.prototype.init = function () {
        ...
        function u(e) {
            l.modal("show"), a.removeClass("was-validated"), a[0].reset(), g("#event-title").val(), g("#event-category").val(), t.text("Make an Appointment"), r = e
        }
        var m = new FullCalendar.Calendar(v, {
            ...
            eventClick: function (e) {
                l.modal("show"), a[0].reset(), i = e.event, g("#event-title").val(i.title), g("#event-category").val(i.classNames[0]), r = null, t.text("Edit Appointment"), r = null
            },
