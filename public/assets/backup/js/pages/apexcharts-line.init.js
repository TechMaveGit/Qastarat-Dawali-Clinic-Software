...
(chart = new ApexCharts(document.querySelector("#syncingchart-line"), options)).render();
var optionsArea = {
        series: [{
            data: generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 20, {
                min: 10,
    ...
    chartArea = new ApexCharts(document.querySelector("#syncingchart-area"), optionsArea);
...
(chart = new ApexCharts(document.querySelector("#line_chart_realtime"), options)).render(), window.setInterval(function () {
