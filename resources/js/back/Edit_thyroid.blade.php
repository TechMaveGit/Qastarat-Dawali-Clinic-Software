...
// Start Image    
    ...
    const imageObj = new Image();
        ...
        @php
        $imageSrc = $thyroidEligibilityFormsImage ? asset('public/assets/thyroid-eligibility-form/' . $thyroidEligibilityFormsImage->AnnotateimageData) : asset('path/to/default/image.png');
        @endphp
        ...
        imageObj.onload = function() {
            ...
            // Add the image to your Konva stage or layer here
            layer.add(image);
            layer.draw();
        };
                            ...
                            $.ajax({
                                            ...
                                            success: function(response) {
                                                ...
                                                if(response!=''){
                                                    ...
                                                    Swal.fire({
                                                                title: 'Success',
                                                                text: 'Thyroid form updated successfully!',
                                                                icon: 'success',
