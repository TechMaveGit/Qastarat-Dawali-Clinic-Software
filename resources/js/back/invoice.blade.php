                                                ...
                                                <td>
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" value=""
                                                            ...
                                                            {{ $alltaskInvoice->paidStatus == '1' ? 'checked' : '' }}>

                                                        <label class="form-check-label"
                                                            for="flexCheckDefault{{ $key + 1 }}">
                                                    ...
                                                    <td data-title="Action">
                                                        <div class="dltwh_check">
                                                            ...
                                                            <div class="round_custom">
                                                                <input type="checkbox"
                                                                    onclick="checkData(`{{ $alltaskInvoice->id }}`,`amount{{ $key + 2 }}`,`discount{{ $key + 2 }}`,`vat{{ $key + 2 }}`,this,`{{ $pathology_price_list->test_name ?? '' }}`,`{{ $patient->name ?? '' }}`,`{{ $patient->email ?? '' }}`,`{{ \Carbon\Carbon::parse($alltaskInvoice->created_at)->format('M d, Y') }}`)"
                                                                    id="checkbox3{{ $key + 1 }}" />
