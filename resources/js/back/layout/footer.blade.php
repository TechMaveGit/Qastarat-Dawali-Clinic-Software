...
<div class="modal fade " id="showReferalMessage" tabindex="-1" aria-labelledby="exampleModalLabel"
   aria-hidden="true">
             ...
             <div class="inner_data">
                <div class="row">
                    ...
                    <div class="created_snippet">
                        <p class="note_created_snippet">You can store often used blocks of text  to speed up data entry in medical records. </p>

                        <ul class="created_snippet_list">
                            @php
                                $note_name =  DB::table('progress_note_contents')->orderBy('id', 'DESC')->get();
                            @endphp
                            @forelse ($note_name as $allnote_name)
                                @php
                                    $progressNoteCan = DB::table('progress_note_canned_text')->where('id', $allnote_name->progress_note_id)->first();
                                @endphp
                                <li data-note-id="{{ $allnote_name->id }}">
                                    <div class="snippet_name">
                                        <p>{{ $progressNoteCan->canned_name ?? '' }} - {{ $allnote_name->note_name ?? '' }}  </p>
                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-6" >
                                    ...
                                    <div class="inner_element w-100">
                                        <div class="form-group">
                                            <input type="text" name="newContext" class="form-control" placeholder="Type a new context">
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6" >
                                    ...
                                    <div class="inner_element w-100">
                                        <div class="form-group">
                                            <input type="text" name="snippetText" class="form-control" placeholder="Give your Snippet Title">
                                        </div>
                                    </div>
                                ...
                                <div class="mt-2 form-group">
                                        <textarea class="form-control" name="snippetDescription" placeholder="Type or paste in your text snippet here.." style="height:100px"></textarea>
                                    </div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="report_check_box">
                            ...
                            <div class="form-group">
                            <input type="checkbox"  name="pastMedicalHistory" value="Past Medical History" id="a2">
                            <label for="a2">Past Medical History</label>
                            </div>
                            <div class="form-group">
                            <input type="checkbox" name="pastSurgicalHistory" value="Past Surgical History" id="a3">
                            <label for="a3">Past Surgical History</label>
                            </div>
                            <div class="form-group">
                            <input type="checkbox" name="oldCurrentMeds" value="Old Current Meds" id="a4">
                                   ...
                                   <div class="col-lg-12">
                                       ...
                                       <div class="report_check_box">
                                           ...
                                           @if ($show)
                                               ...
                                               <h1 class="modal-title" id="exampleModalLabel">Your Comment
                                                    </h1>
                                               <hr style="background: #060606;">

                                               <textarea class="form-control" id="appendReply" class="appendReply" style="height:150px" readonly></textarea>


                                           @else
                                               <h1 class="modal-title" id="exampleModalLabel">Comment
                                                    </h1>
                                               <hr style="background: #060606;">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="report_check_box">
                                    ...
                                    <textarea class="form-control" id="viewOrderSummary_" name="patientSummary" placeholder="Summary...." style="height:150px"></textarea>
...
<div class="modal fade edit_patient__" id="viewOrderCallSummary" tabindex="-1" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
...
function ViewSummary(formType, fileName ,documentUrl, reply_summary, id) 
       {
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body body-patient">
                            ...
                            @if (!empty($branchs))
                                <div class="col-lg-6">
                                    <div class="mb-3 form-group">
                                        ...
                                        <select class="form-control select2_modal_" name="selectBranch" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <select class="form-control select2_modal_" name="country" id="Selectcountry" required>
                                            <option value="">Select Any One</option>
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2_modal_" name="document_type" id="document_type" style="width: 100%;">
                                            <option value="">Select Any One</option>
                                            <option value="CIVIL ID" {{ old('document_type') == 'CIVIL ID' ? 'selected' : '' }}>CIVIL ID </option>
                                            <option value="EID" {{ old('document_type') == 'EID' ? 'selected' : '' }}>EID</option>
                                            <option value="PERSONAL NUMBER" {{ old('document_type') == 'PERSONAL NUMBER' ? 'selected' : '' }}>PERSONAL NUMBER</option>
                                            <option value="RESIDENT ID" {{ old('document_type') == 'RESIDENT ID' ? 'selected' : '' }}>RESIDENT ID</option>
                                            <option value="PASSPORT, DRIVER's LICENSE, ETC" {{ old('document_type') == 'PASSPORT, DRIVERs LICENSE, ETC' ? 'selected' : '' }}>PASSPORT, DRIVER's LICENSE, ETC</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">    
                                      ...
                                      <input type="text" name="enterIdNumber" id="enterIdNumber" value="{{ old('enterIdNumber') }}" class="form-control" placeholder="">
                    ...
                    <div class="action text-end bottom_modal" style="justify-content: right;
                    display: flex;
                    align-items: center;
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <select class="form-control select2_edit_info" id="Selectcountry_" name="patient_country" required>
                        ...
                        <div class="documentsadd_pat">
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Select Id</label>
                                        <select class="form-control select2_edit_info" name="document_type" id="Edit_document_type" style="width: 100%;">
                                            <option value="">Select Any One</option>
                                            <option value="CIVIL ID" {{ old('document_type') == 'CIVIL ID' ? 'selected' : '' }}>CIVIL ID </option>
                                            <option value="EID" {{ old('document_type') == 'EID' ? 'selected' : '' }}>EID</option>
                                            <option value="PERSONAL NUMBER" {{ old('document_type') == 'PERSONAL NUMBER' ? 'selected' : '' }}>PERSONAL NUMBER</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">    
                                      <label class="form-label">Enter Id Number</label>
                                      <input type="text" name="enterIdNumber" id="editEnterIdNumber" value="{{ old('enterIdNumber') }}" class="form-control" placeholder="">
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="inner_element">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control basicDate" placeholder="M, dd yyyy" name="today_date">
    ...
    <div class="col-lg-3" id="stoppedDateDiv">
        <div class="inner_element">
            <div class="form-group">
                ...
                <input type="text" class="form-control basicDate" placeholder="M, dd yyyy" name="stopped_date">
            </div>
        </div>
    </div>
...
<!----------------------------
            ...
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('referalPatient') }}" method="post" id="refer_form"  enctype="multipart/form-data"> @csrf
                        <input type="hidden" name="patient_id" value="{{ @$id }}" >
                        <div class="modal-body padding-0">
                                    ...
                                    <div class="row top_head_vitals">
                                        ...
                                        <div class="col-lg-12 px-4 mb-3 ok" id="refer_note">
                                            ...
                                            <div class="mt-3 form-group">
                                                ...
                                                <textarea class="form-control" name="patientSummary"
                                                    placeholder="Summary...."
                                                    style="height:150px"></textarea>
                                        ...
                                        <div class="col-lg-12 px-4 mb-3" id="refer_note">
                                            <h6 class="" style="font-size: 16px; color: #707883;">Upload Document</h6>    
                                            <div class="mt-3 form-group">
                                    ...
                                    <div class="top_snippet_">
                                        ...
                                        <div class="right_bgi">
                                            <div class="add_btn_plus">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#add_newnote">Add New Snippet</a>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <button  class="startRecognition" id="startRecognition">Start Voice Recognition</button> --}}
                                                            ...
                                                            <p>
                                                                <a href="javascript:void(0)" class="mic_btn" role="button" aria-label="Start/Stop voice recognition">
                                                                    <i class="fa-solid fa-microphone startRecognition_" id="startRecognition_" aria-hidden="true"></i>
                                                                </a> 
                                                        ...
                                                        <div class="inner_element w-100">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control"
                                                                        placeholder="Email" id="email" name="prog_email"
                                                        ...
                                                        <div class="inner_element w-100">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    placeholder="Mobile Phone" step="0.01" min="0" max="15" id="prog_mobile_no"
                                                                    name="prog_mobile_no">
...
<!----------------------------
            ...
            ---------------------------->
            <div class="modal fade attach_document" id="attach_document" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-2 form-group">
                                                ...
                                                <input type="text" class="form-control" name="documentName" id="documentName" placeholder="">
                                        ...
                                        <div class="col-lg-12">   
                                            <div class="mb-2 form-group">
                                                ...
                                                <input name="file" type="file" class="form-control" id="uploadDocument" />
                                            </div>
                                        </div>
...
<div class="modal fade makeAppoinment" id="make_appointment" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                                ...
                                <div class="row appointment_book">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="inner_element">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2_appoin_ttype__" name="priority" id="Priority">
                                        ...
                                        <div class="inner_element">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    @endphp
                                                      ...
                                                      <select class="form-control select2_appoin_ttype__" name="appointment_type" required>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="inner_element">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2_appoin_ttype__" name="location" id="location" required>
                                                    <option value=""> --Select Location Type-- </option>
                                                    @forelse ($allBranch as $allallBranch)
                                                       <option value="{{ $allallBranch->id }}">{{ $allallBranch->branch_name }}</option>
                                                    @empty
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="inner_element">
                                            ...
                                            <div class="form-group">
                                                @php
                                                   $Clinician = DB::table('doctors')->where('status','active')->get();
                                                @endphp

                                                <select class="form-control select2_appoin_ttype__" name="doctor_id" required>
                                                    <option value=""> --Select Clinician Type-- </option>
                                                    @forelse ($Clinician as $allClinician)
                                                       <option value="{{ $allClinician->id }}">{{ $allClinician->name }}</option>
                                                    @empty
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="inner_element">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control" placeholder="12:00" name="start_time">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="inner_element">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control" placeholder="12:00" name="end_time">
...
<script>
        ...
        document.getElementById('meeting_date').min = getCurrentDateTime();
    </script>
...
<script>
    $(document).ready(function() {
        ...
        $('.datetimepickerInput_').datetimepicker({
            dateFormat: 'yy-mm-dd',
            timeFormat: 'HH:mm',
            minDate: 0,
        });
        ...
        $('.alergyDelete').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.allergy.delete", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.pastMedicalHistoryDelete').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.past.medical.delete", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.patientPastSurgical').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.past.surgical", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.orderProcedure').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.order.procedure", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.removeNotes').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.progress.note", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.removeFuturePlan').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.future.plans", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.patientRemoveDrug').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patientRemoveDrug", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.patientListOf').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("list.of.procedure", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.supportiveTrea').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.supportive.treatments", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.prescriptionsMedicines').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.prescribed.medicines", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.removeReferalPatient').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.referrals", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.removeMbtReview').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.mbt", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.removeEligibilityStatus').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("patient.eligibility.status", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
    ...
    $(document).ready(function() {
        $('.reportDelete').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("deleteReport", ":id") }}'.replace(':id', allergyId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    if (!('webkitSpeechRecognition' in window)) {
        ...
        recognition.onstart = () => {
            ...
            startRecognitionButton.innerHTML += '<i class="fa-solid fa-times stopRecognition_" id="stopRecognition_" aria-hidden="true" style="margin-left: 10px;"></i>';
        };
