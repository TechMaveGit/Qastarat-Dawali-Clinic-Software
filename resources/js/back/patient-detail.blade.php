                                    ...
                                    <div class="data_pt">
                                        ...
                                        <h6 id="data_pt_kin">
                                            @forelse ($patient->userBranch as $getbranchName)
                                                {{ $getbranchName->userBranchName->branch_name ?? '' }} @if (!$loop->last)
                                                    ,
                                                @endif
                                                </p>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data && data.hasOwnProperty('patient_info')) {
                            ...
                            $('#Selectcountry_').val(selectedCountry).trigger('change.select2');
                            ...
                            $("#editEnterIdNumber").val(enterIdNumber);
                            $('#Edit_document_type').val(selectedDocument_type).trigger('change.select2');
