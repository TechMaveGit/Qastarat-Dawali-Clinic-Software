        ...
        <div class="row">
            ...
            <div class="col-xl-3">
                ...
                <div class="footer-info mb-0">
                    ...
                    <img class="footer-logo" src="{{ url('public/assets') }}/images/new-images/qastrat-logo2.png" alt="footer-logo">

                    <img class="footer-logo-dark" src="{{ url('public/assets') }}/images/new-images/qastrat-logo2.png" alt="footer-logo">
                ...
                <div class="footer-links fl-1">
                    ...
                    <ul class="foo-links clearfix">
                        ...
                        <li>
                            ...
                            <p><a href="{{ route('user.dashboard') }}">Home</a></p>

                        </li>

                        <li>

                            <p><a href="{{ route('user.patient') }}">Patients</a></p>
            ...
            <div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="footer-copyright">
                        ...
                        <p class="p-sm">2023-24, All Right Reserved by Qastarat & Dawali Clinics - Developed by <a href="https://techmavesoftware.com/">TechMave Software</a> .</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="" name="patient_id">
                                        <span id="patient_idError" style="color: red;font-size:smaller"></span>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" class="form-control" id="patient_insurer" placeholder="" name="patient_insurer">
                                ...
                                <div class="inner_element mt-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="stopped" id="flexCheckDefault2" value="is_stopped">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body padding-0">
                ...
                <div class="action text-end bottom_modal">
                    ...
                    <a href="{{ route('front.service.page') }}" class="btn r-04 btn--theme hover--tra-black add_patient">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="inner_element">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Diseases Name" name="surgery_name">
