				  	...
				  	<div class="wsmainfull menu clearfix">
	    				...
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						...
	    						<a href="{{ route('user.dashboard') }}" class="logo-black">
                            ...
                            <nav class="wsmenu clearfix">
	        					...
	        					<ul class="wsmenu-list nav-theme">
							    	...
							    	<li class="nl-simple {{ Request::segment(2)=='dashboard' ? 'active': '' }}" aria-haspopup="true"><a href="{{ route('user.dashboard') }}" class="h-link">Home</a></li>



								    <!-- SIMPLE NAVIGATION LINK -->

							    	<li class="nl-simple {{ Request::segment(2)=='patient' ? 'active': '' }}" aria-haspopup="true"><a href="{{ route('user.patient') }}" class="h-link">Patients</a></li>
