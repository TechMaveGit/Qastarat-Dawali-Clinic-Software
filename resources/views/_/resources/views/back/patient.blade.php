...
<div class="sub_bnr" style="background-image: url(images/hero-15.jpg);">
...
<div class="sub_bnr_cnt">
    ...
    <div id="search-container" class="search_bar">
        ...
        <input type="text" class="form-control" id="searchInput" placeholder="Find a patient by name, street, post code , mobile or ID number" onkeyup="fetchAndDisplayPatients(this.value)">
                        ...
                        <table id="allinvoice_table" class="display">
                           ...
                           <tbody id="patientData">
                              ...
                              {{-- <tr>
                                 ...
                                 <a href="{{ route('user.invoice') }}" class="btn r-04 btn--theme hover--tra-black add_patient view_invoice"><i class="fa-regular fa-file-lines"></i> View Invoice</a>

                                 <a href="{{ route('user.view-medical-report') }}" class="btn r-04 btn--theme hover--tra-black add_patient view_medical_record"><i class="fa-regular fa-rectangle-list"></i> View Medical Record </a>
    ...
    $(document).ready(function() {
        ...
        // data-bs-dismiss="modal"
            ...
            if (patient_id === '') {
                ...
                $('#patient_idError').text('document type  is required');
                $('input[name="patient_id"]').addClass('error');
            }
                ...
                if (data && data.length > 0) {
                    data.forEach(function(patient, index) {
                        let row = '<tr >' +
                                    ...
                                    '<td>' +
                                    '<a href="' + patient.id + '" class="btn r-04 btn--theme hover--tra-black add_patient view_invoice">' +
                                    '<i class="fa-regular fa-file-lines"></i> View Invoice</a>' +
                                    '<a href="patient-medical-detail/'+patient.id+'" class="btn r-04 btn--theme hover--tra-black add_patient view_medical_record">' +
                    ...
                    $('#patientData').html('<tr><td colspan="3">No patients found.</td></tr>');
                }
            },
