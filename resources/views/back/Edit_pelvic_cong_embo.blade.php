    ...
    <div class="eligiblity-form">
        ...
        <div class="container">
            <div class="form_inner_dt">
                <form method="POST" action="{{ route('user.updatePelvicCongEmboEligibilityForms') }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="inner_element">
                                                    <div class="form-group">
                                                        <textarea class="form-control" placeholder="Type here..." style="height: 43px" name="symptoms[9][3]">{{ trim($disfiguringSymptoms11['SymptomDurationNote'] ?? '') }}
                                                        </textarea>
                                                    </div>
                                                </div>
                                            </div>
