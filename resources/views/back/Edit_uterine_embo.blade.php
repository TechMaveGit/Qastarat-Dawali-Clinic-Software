          ...
          <div class="col-lg-12" id="textarea_83">
              <div class="form-check form-check-right mb-3 ps-0">
                <textarea class="form-control" placeholder="Enter Elaborate Malignant PAP / notes here***"  style="height: 100px" name="Lab[PAPSMEARResultsNote][]" >{{ $Lab['PAPSMEARResultsNote'][0] ?? '' }}</textarea>
                                    ...
                                    <div class="col-lg-12">
                                        <h6 class="section_title__">Eligibility STATUS <a target="_blank"  href="{{ route('user.viewUterineEmboEligibilityForms',['id'=>@$patient_id ]) }}"
                                                class="order-now_btn">Medical Record <i
...
<script>
    ...
    // End Image 
        ...
        <script>
            $(document).ready(function() {
                @if (isset($MDTs['UFE'][0]) && $MDTs['UFE'][0] == 'UFE')
                $("#textarea_84").show();
                @else
                ...
                $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if(response!=''){
                                        ...
                                        Swal.fire({
                                                        title: 'Success',
                                                        text: 'Uterine embo  form updated successfully!',
                                                        icon: 'success',
