    ...
    <div class="eligiblity-form">
        ...
        <div class="container">
            <div class="form_inner_dt">
                <form method="POST" action="{{ route('user.storeKneePainEligibilityForms') }}"
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[NonsepticArthritis][]" id="formRadiosRight7"
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[SepticArthritis][]" id="formRadiosRight7"
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[Bursitis][]" id="formRadiosRight7"
                                                value="Bursitis">
                                            <label class="form-check-label" for="formRadiosRight7">
                                                Bursitis
                                            </label>
                                    ...
                                    <div class="col-lg-4"  >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[hemoarthrosis][]" id="formRadiosRight7"
                                                value="hemoarthrosis">
                                            <label class="form-check-label" for="formRadiosRight7">
                                                hemoarthrosis
                                            </label>
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[OCD][]" id="formRadiosRight7"
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[PatellaChondromalacia][]" id="formRadiosRight7"
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[PatellaSubluxation][]" id="formRadiosRight7"
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[kneeDeformity][]" id="formRadiosRight7"
                                    ...
                                    <div class="col-lg-4" id="diagnosis_general_checkbox" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[Kneeloosebody][]" id="formRadiosRight7"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M232][]"
                                                id="formRadiosRight11" value="M23.2 Derangement of meniscus due to old tear or injury">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M233][]"
                                                id="formRadiosRight12" value="M23.3 Other meniscus derangements">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M234][]"
                                                id="formRadiosRight13" value="M23.4 Loose body in knee">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M235][]"
                                                id="formRadiosRight14" value="M23.5 Chronic instability of knee">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M236][]"
                                                id="formRadiosRight15" value="M23.6 Other spontaneous disruption of ligaments of knee">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M238][]"
                                                id="formRadiosRight16" value="M23.8 Other internal derangements of knee">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M239][]"
                                                id="formRadiosRight17" value="M23.9 Internal derangement of knee, unspecified">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M244][]"
                                                id="formRadiosRight18" value="M24.4 Recurrent dislocation and subluxation of joint Derangement|cartilage (articular) NEC|knee, meniscus|recurrent">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S800][]"
                                                id="formRadiosRight19" value="S80.0 Contusion of knee">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S810][]"
                                                id="formRadiosRight19" value="S81.0 Open wound of knee">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S820][]"
                                                id="formRadiosRight19" value="S82.0 Fracture of patella">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S830][]"
                                                id="formRadiosRight19" value="S83.0 Dislocation of patella">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S831][]"
                                                id="formRadiosRight19" value="S83.1 Dislocation of knee">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S832][]"
                                                id="formRadiosRight19" value="S83.2 Tear of meniscus, current">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S833][]"
                                                id="formRadiosRight19" value="S83.3 Tear of articular cartilage of knee, current">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S836][]"
                                                id="formRadiosRight19" value="S83.6 Sprain and strain of other and unspecified parts of knee">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S837][]"
                                                id="formRadiosRight19" value="S83.7 Injury to multiple structures of knee">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S899][]"
                                                id="formRadiosRight19" value="S89.9 Unspecified injury of lower leg">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[Q682][]"
                                                id="formRadiosRight19" value="Q68.2 Congenital deformity of knee">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[Q741][]"
                                                id="formRadiosRight19" value="Q74.1 Congenital malformation of knee Hypertrophy, hypertrophic|meniscus, knee, congenital">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M705][]"
                                                id="formRadiosRight19" value="M70.5 Other bursitis of knee">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M17][]"
                                                id="formRadiosRight19" value="M17 Gonarthrosis [arthrosis of knee]">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M704][]"
                                                id="formRadiosRight19" value="M70.4 Prepatellar bursitis, Housemaid's knee">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M768][]"
                                                id="formRadiosRight19" value="M76.8 Other enthesopathies of lower limb, excluding foot">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M794][]"
                                                id="formRadiosRight19" value="M79.4 Hypertrophy of (infrapatellar) fat pad">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M210][]"
                                                id="formRadiosRight19" value="M21.0 Valgus deformity, not elsewhere classified. Knock knee (acquired)">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M2441][]"
                                                id="formRadiosRight19" value="M24.4 Recurrent dislocation and subluxation of joint">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M256][]"
                                                id="formRadiosRight19" value="M25.6 Stiffness of joint, not elsewhere classified">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[L031][]"
                                                id="formRadiosRight19" value="L03.1 Cellulitis of other parts of limb">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M243][]"
                                                id="formRadiosRight19" value="M24.3 Pathological dislocation and subluxation of joint, not elsewhere classified">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M219][]"
                                                id="formRadiosRight19" value="M21.9 Acquired deformity of limb, unspecified, Deformity knee (acquired) NEC">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M062][]"
                                                id="formRadiosRight19" value="M06.2 Rheumatoid bursitis">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M652][]"
                                                id="formRadiosRight19" value="M65.2 Calcific tendinitis Calcification|tendon (sheath)|with bursitis, synovitis or tenosynovitis">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M932][]"
                                                id="formRadiosRight19" value="M93.2 Osteochondritis dissecans Osteochondrosis dissecans (knee) (shoulder)">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S836][]"
                                                id="formRadiosRight19" value="S83.6 Sprain and strain of other and unspecified parts of knee Injury|knee meniscus (lateral) (medial)">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S837][]"
                                                id="formRadiosRight19" value="S83.7 Injury to multiple structures of knee Injury to (lateral)(medial) meniscus in combination with (collateral) (cruciate) ligaments">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" id="Postpartum_thyroiditis">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[Z895][]"
                                                id="formRadiosRight19" value="Z89.5 Acquired absence of leg at or below knee">
                                            <label class="form-check-label" for="formRadiosRight19">
