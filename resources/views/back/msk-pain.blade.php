                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[Capsulitis][]" id="formRadiosRight6"
                                                value="Capsulitis">
                                    ...
                                    <div class="col-lg-4" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[Tendontear][]" id="formRadiosRight7CervicalSpndylolysis"
                                                value="Tendon tear">
                                    ...
                                    <div class="col-lg-4"  id="diagnosis_general_checkbox">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox"
                                                name="diagnosis_general[NerveImpengment][]" id="formRadiosRight7LumbarFacetArthropathy"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M658][]"
                                                id="formRadiosRight11" value="M65.8 Other synovitis and tenosynovitis Tendinitis, tendonitis|adhesive">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M659][]"
                                                id="formRadiosRight12" value="M65.9 Synovitis and tenosynovitis, unspecified Disease, diseased|tendon, tendinous inflammatory NEC ">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M665][]"
                                                id="formRadiosRight13" value="M66.5 Spontaneous rupture of unspecified tendon Rupture at musculotendinous junction, nontraumatic">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M678][]"
                                                id="formRadiosRight14" value="M67.8 Other specified disorders of synovium and tendon Disease, diseased tendon, tendinous|specified NEC">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M679][]"
                                                id="formRadiosRight15" value="M67.9 Disorder of synovium and tendon, unspecified Disease, diseased tendon, tendinous">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M701][]"
                                                id="formRadiosRight16" value="M70.1 Bursitis of hand">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M702][]"
                                                id="formRadiosRight17" value="M70.2 Olecranon bursitis">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M703][]"
                                                id="formRadiosRight18" value="M70.3 Other bursitis of elbow">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M706][]"
                                                id="formRadiosRight19M510" value="M70.6 Trochanteric bursitis Trochanteric tendinitis">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M707][]"
                                                id="formRadiosRight19M511" value="M70.7 Other bursitis of hip">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M708][]"
                                                id="formRadiosRight19M512" value="M70.8 Other soft tissue disorders related to use, overuse and pressure Tendinitis, tendonitis|due to use, overuse, pressure|specified NEC">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M709][]"
                                                id="formRadiosRight19M519" value="M70.9 Unspecified soft tissue disorder related to use, overuse and pressure Tendinitis, tendonitis|due to use, overuse, pressure">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M711][]"
                                                id="formRadiosRight19M541" value="M71.1 Other infective bursitis">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M715][]"
                                                id="formRadiosRight19M542" value="M71.5 Other bursitis, not elsewhere classified">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M719][]"
                                                id="formRadiosRight19M530" value="M71.9 Bursopathy, unspecified Bursitis NOS">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M750][]"
                                                id="formRadiosRight19M545" value="M75.0 Adhesive capsulitis of shoulder Tendinitis, tendonitis|adhesive|shoulder">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M752][]"
                                                id="formRadiosRight19Q765" value="M75.2 Bicipital tendinitis">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M753][]"
                                                id="formRadiosRight19S122" value="M75.3 Calcific tendinitis of shoulder ">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M755][]"
                                                id="formRadiosRight19S127" value="M75.5 Bursitis of shoulder">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M760][]"
                                                id="formRadiosRight19S131" value="M76.0 Gluteal tendinitis">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M761][]"
                                                id="formRadiosRight19S134" value="M76.1 Psoas tendinitis">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M764][]"
                                                id="formRadiosRight19" value="M76.4 Tibial collateral bursitis [Pellegrini-Stieda]">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M765][]"
                                                id="formRadiosRight19" value="M76.5 Patellar tendinitis">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M766][]"
                                                id="formRadiosRight19" value="M76.6 Achilles tendinitis">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M767][]"
                                                id="formRadiosRight19" value="M76.7 Peroneal tendinitis">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M768][]"
                                                id="formRadiosRight19" value="M76.8 Other enthesopathies of lower limb, excluding foot Posterior tibial tendinitis">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M775][]"
                                                id="formRadiosRight19" value="M77.5 Other enthesopathy of foot Bursitis calcaneal">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M778][]"
                                                id="formRadiosRight19" value="M77.8 Other enthesopathies, not elsewhere classified Bursitis radiohumeral">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" >
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[M779][]"
                                                id="formRadiosRight19" value="M77.9 Enthesopathy, unspecified Tendinitis NOS">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12" id="Postpartum_thyroiditis">
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" name="diagnosis_cid[S378][]"
                                                id="formRadiosRight19" value="S37.8 Injury of other pelvic organs Injury|broad ligament">
                                            <label class="form-check-label" for="formRadiosRight19">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="form-check form-check-right mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="symptoms[5][0]" value="Lethargy"
                                                        id="sym_a75">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="form-check form-check-right mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="symptoms[6][0]" value="Fatigue"
                                                        id="sym_a7">
                                ...
                                <div class="mb-3 form-group">
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    ...
                                                    <div class="col-lg-12 mb-3">
                                                        ...
                                                        <div class="col-lg-4">
                                                                ...
                                                                <div class="text_area_gfhi mb-3">
                                                                <textarea class="form-control" placeholder="Enter Elaborate Rheumatology / notes here***" style="height: 100px" name="Lab[LABJFA15Note][]"></textarea>
                                                                </div>
                                                            </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-4">
                                                ...
                                                <div class="form-check form-check-right mb-3 ps-0">
                                                <textarea class="form-control" placeholder="Enter Elaborate  / notes here***" style="height: 100px" name="ElegibilitySTATUS[STENote][]" ></textarea>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
            ...
            if (!validateForm()) {
                ...
                $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: 'Msk Pain form saved successfully!',
                                                icon: 'success',
