          ...
          <div class="tm_invoice_in">
            ...
            <div class="tm_invoice_head tm_mb10 ">
              <div class="tm_invoice_left">
                ...
                <p style="width: 60%;">
                Dubai Health City 1
  Al Jalila Foundation, Building 12
  Ground floor (G02)
  0581114000
                </p>
                <p> Qastaratclinicsdubai@gmail.com</p>
              </div>
              <div class="tm_invoice_right tm_text_right">
            ...
            <div class="cutarea_box">
                <img src="invoiceassets/img/cuttingicon.png" alt="">
            </div>
     ...
     <div class="cs-note_right">
        <p class="cs-mb0"><b class="cs-primary_color cs-bold">TAZEEZ MEDICAL SAENF8YY</b></p>
     </div>
  </div>
  
  
            <div class="tm_table tm_style1 tm_mb30 tm_mt20">
              <div class="tm_round_border">
                <div class="tm_table_responsive">
                  <table>
                    <thead>
                      <tr>
                        <th class="tm_width_3 tm_semi_bold tm_primary_color tm_gray_bg">Total Due</th>
                        <th class="tm_width_4 tm_semi_bold tm_primary_color tm_gray_bg">Amount Paid</th>
                        <th class="tm_width_2 tm_semi_bold tm_primary_color tm_gray_bg">Date Paid </th>
                        <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg">Payment Method</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
            ...
            <div class="tm_invoice_head tm_mb10 ">
              ...
              <div class="tm_invoice_right tm_text_right">
                <p class="tm_mb2"><b class="tm_primary_color">Thomas Denny</b></p>
