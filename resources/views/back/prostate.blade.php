...
// Start Image
    ...
    imageObj.src = '{{ asset('public/assets/thyroid-eligibility-form/add/prostate.jpg') }}';
                ...
                $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if(response!=''){
                                        ...
                                        Swal.fire({
                                                    title: '', // Empty title
                                                    text: 'Prostate form saved successfully!!', // Success message
                                                    icon: 'success',
                                        ...
                                        //     'Prostate form saved successfully!',
