...
@section('content-section')
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            @endphp
                                                                            @if (isset($sum) && ($sum >= 0 && $sum <= 10))
                                                                            <p class="ss_result">Mild LUTS (1-10 pts)</p>
                                                                            @elseif (isset($sum) && ($sum >= 11 && $sum <= 20))
                                                                            <p class="ss_result">Moderate LUTS (11-20 pts)</p>
                                                                            @elseif (isset($sum) && ($sum >= 21 && $sum <= 1009))
                                                                            <p class="ss_result">Severe LUTS (21-30 pts)</p>
                                                                            @endif
                                                                       ...
                                                                       @if (isset($jsonData) && is_array($jsonData) && array_key_exists("AnalFissure",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                            ...
                                                                            <p class="ss_result">{{ $jsonData['AnalFissure'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("AnalDischarge",$jsonData) )
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $jsonData['AnalDischarge'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("Fistulainano",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                            ...
                                                                            <p class="ss_result">{{ $jsonData['Fistulainano'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("Hemarrhoidectomy",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Failed Prior Surgical Hemarrhoidectomy</h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['Hemarrhoidectomy'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("Laser",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Failed Prior Laser Hemarrhoidectomy</h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['Laser'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-3">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            USVENOUSDOPPLER70  > Hemarrhoids endorectal US Protocol Findings</h6>
                                                                            </div>

                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">External Hemarrhoids<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['ExternalHemarrhoids'][0] ?? '' }}</p>
                                                                                
                                                                                    

                                                                            </div>
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Internal Hemarrhoids<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['InternalHemarrhoids'][0] ?? '' }}</p>
                                                                                
                                                                                    

                                                                            </div>
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Suspicious Anal Mass<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['SuspiciousAnalMass'][0] ?? '' }}</p>
  ...
  <div class="ss_result_box">
    <div class="symp_title mb-3">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    MRCIR48 > Hemarrhoids MRI Protocol Findings</h6>
    </div>

    <div class="symp_title mb-3">
        <p class="ss_result">Prominent SRA arteries<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['ProminentSRAarteries'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title mb-3">
        <p class="ss_result">Dilated anal veins<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Dilatedanalveins'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title mb-3">
        <p class="ss_result">thrombosed hemorrhoids<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['thrombosedhemorrhoids'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title mb-3">
        <p class="ss_result">Congested pelvic veins<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Congestedpelvicveins'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title mb-3">
        <p class="ss_result">Suspicious ano-rectal mass</p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Suspicious'][0] ?? '' }}</p>
...
<div class="ss_result_box">
    <div class="symp_title mb-3">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    CTCIR48 > CTA - Pelvic Protocol - Findings</h6>
    </div>

    <div class="symp_title mb-3">
        <p class="ss_result">Superior Hemorrhoidal arteries<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['SuperiorHemorrhoidalarteries'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title mb-3">
        <p class="ss_result">Middle Hemorrhoidal arteries<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['MiddleHemorrhoidalarteries'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title mb-3">
        <p class="ss_result">Inferior Hemorrhoidal arteries<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['InferiorHemorrhoidalarteries'][0] ?? '' }}</p>
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        <p class="diagnosis_date top_de"><span
                                                                            ...
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            LABCRCMARKERS000 > FERTILITY HORMONES Results</h6>

                                                                            </div>

                                                                            <p class="ss_result"><strong>CEA</strong> -
                                                                            ...
                                                                            <p class="ss_result"><strong>CA-125</strong>
...
<div class="ss_result_box">
    <div class="symp_title ">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    HCLGIENDOSCOPY000 > LGI Endoscopy Findings</h6>
    </div>

    <div class="symp_title ">
        <p class="ss_result">External hemorrhoids<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Externalhemorrhoids'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title ">
        <p class="ss_result">Internal hemorrhoids<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Internalhemorrhoids'][0] ?? '' }}</p>
    ...
    <div class="symp_title ">
        <p class="ss_result">Ano-rectal Bnign Polyp<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['BnignPolyp'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title ">
        <p class="ss_result">Ano-rectal Malignanat Polp<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Polp'][0] ?? '' }}</p>
    ...
    <div class="symp_title ">
        <p class="ss_result">Ano-rectal Malignanat tumor<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['tumor'][0] ?? '' }}</p>
    ...
    <div class="symp_title ">
        <p class="ss_result">Ano-rectal Ulcer<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Ulcer'][0] ?? '' }}</p>
    ...
    <div class="symp_title ">
        <p class="ss_result">Anal fissure<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Analfissure'][0] ?? '' }}</p>
        
            

    </div>
    <div class="symp_title ">
        <p class="ss_result">Fistula in ano<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['Fistula'][0] ?? '' }}</p>
...
<div class="ss_result_box">
    <div class="symp_title ">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    REQLGIENDOSCOPY5 > Lower GI endoscopy</h6>
    </div>

    <div class="symp_title ">
       
            @if (isset($specialInvestigations['endoscopy']) && $specialInvestigations['endoscopy'][0]=='Abnormal')
            <p class="ss_result">{{ $specialInvestigations['endoscopy'][0] ?? '' }}</p>
            <p class="ss_result">
                &nbsp;&nbsp;{{ $specialInvestigations['endoscopyNote'][0] ?? '' }}</p>
                @else
                <p class="ss_result">
                    &nbsp;&nbsp;{{ $specialInvestigations['endoscopy'][0] ?? '' }}</p>
            @endif
                                                            ...
                                                            <div class="appoin_date">
                                                                <div class="read-more-content " style="">
                                                                        ...
                                                                        <p class="diagnosis_date "><span
                                                                           ...
                                                                           @if (isset($MDT['HE']) && $MDT['HE'][0]=='HE')
                                                                            <div class="ss_result_box">
                                                                                ...
                                                                                <p class="ss_result"> {{ $MDT['HENote'][0] ?? ''  }}</p>
                                                                            </div>
                                                                            @endif
                                                                    ...
                                                                    @if (isset($MDT['options']) && $MDT['options'][0]=='options')
                                                                        ...
                                                                        @if (! isset($MDT['options']) || ! isset($MDT['Surgical']) ||  ! isset($MDT['Medical'])  || ! isset($MDT['HE']))
                                                                ...
                                                                <div class="read-more-content " style="">
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result"> {{ $ElegibilitySTATUS['HEMARRHOIDSEMBOLIZATIONNote'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        @endif
                                                                        @if (! isset($ElegibilitySTATUS['Others']) || ! isset($ElegibilitySTATUS['HEMARRHOIDSEMBOLIZATION']) )
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="Add_Diagnosis">
                    ...
                    <input type="hidden" value="HaemorrhoidsEmbo" name="formType"/>
