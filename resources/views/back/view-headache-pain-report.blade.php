                                                                       ...
                                                                       @if (isset($jsonData) && is_array($jsonData) && array_key_exists("Softtissue",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Soft tissue infection or inflammation (acute pain | acute fever | acute swelling | acute redness)</h6>
                                                                            </div>
                                                            ...
                                                            <div class="appoin_date">
                                                                <div class="read-more-content " style="">
                                                                    ...
                                                                    @if (isset($MDT['options']) && $MDT['options'][0]=='options')
                                                                        ...
                                                                        @if (! isset($MDT['IRprocedure']) || ! isset($MDT['IRprocedureNote']) || ! isset($MDT['Medical']) ||  ! isset($MDT['MedicalNote']) ||  ! isset($MDT['Surgical'])  || ! isset($MDT['SurgicalNote']) ||  ! isset($MDT['options']) || ! isset($MDT['optionsNote']))
                                                            ...
                                                            <div class="appoin_date">
                                                                <div class="read-more-content " style="">
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        @if (! isset($ElegibilitySTATUS['Others']) 
