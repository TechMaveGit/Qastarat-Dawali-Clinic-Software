                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('knee_pain','diagnosis')" class="bottom_btn extract_btn"
                                                                        >
                                                        ...
                                                        <div class="enterd_by">
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        <a onclick="viewDocument('knee_pain','symptoms')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                                                ...
                                                                                @if (isset($jsonData) && is_array($jsonData) && array_key_exists('SepticKnee', $jsonData))
                                                                                    <div class="ss_result_box">
                                                                                        <div class="symp_title mb-1">
                                                                                            <h6><span class="point_dia"><i
                                                                                                        class="fa-regular fa-circle-dot"></i></span>
                                                                                                Septic Knee (acute pain |
                                                                                                acute fever | acute swelling
                                                                                                | acute redness)</h6>
                                                                                        </div>
                                                                                        <p class="ss_result">
                                                                                            {{ $jsonData['SepticKnee'][0] ?? '' }}
                                                                                        </p>
                                                                                    </div>
                                                                                @endif
                                                                                @if (isset($jsonData) && is_array($jsonData) && array_key_exists('KneeProsthesis', $jsonData))
                                                                                    <div class="ss_result_box">
                                                                                        <div class="symp_title mb-1">
                                                                                            <h6><span class="point_dia"><i
                                                                                                        class="fa-regular fa-circle-dot"></i></span>
                                                                                                Knee Prosthesis (or Total
                                                                                                Knee Replacement TKR)
                                                                                            </h6>
                                                                                        </div>
                                                                                        <p class="ss_result">
                                                                                            {{ $jsonData['KneeProsthesis'][0] ?? '' }}
                                                                                        </p>
                                                                                    </div>
                                                                                @endif
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Superior Medial GN
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['SuperiorMedialGN'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Inferior Medial GN
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['InferiorMedialGN'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Superior Lateral GN
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['SuperiorLateralGN'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Knee effusion
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['Kneeeffusion'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="diagnosis_show">
                                                                            ...
                                                                            <div class="ss_result_box">
                                                                                <div class="symp_title ">
                                                                                    <h6><span class="point_dia"><i
                                                                                                class="fa-regular fa-circle-dot"></i></span>
                                                                                        REQNERVECON110 > Peripheral Nerve
                                                                                        conduction study</h6>
                                                                                </div>
