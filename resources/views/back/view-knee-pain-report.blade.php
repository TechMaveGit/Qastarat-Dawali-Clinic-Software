                                                            ...
                                                            <div class="appoin_date">
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                       ...
                                                                       @if (isset($jsonData) && is_array($jsonData) && array_key_exists("SepticKnee",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Septic Knee (acute pain | acute fever | acute swelling | acute redness)</h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['SepticKnee'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("KneeProsthesis",$jsonData) )

                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Knee Prosthesis (or Total Knee Replacement TKR)
                                                                                </h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['KneeProsthesis'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Superior Medial GN<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['SuperiorMedialGN'][0] ?? '' }}</p>
                                                                                
                                                                                    

                                                                            </div>
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Inferior Medial GN<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['InferiorMedialGN'][0] ?? '' }}</p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Superior Lateral GN<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['SuperiorLateralGN'][0] ?? '' }}</p>
                                                                                
                                                                                    

                                                                            </div>
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Knee effusion<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['Kneeeffusion'][0] ?? '' }}</p>
                                                                                
                                                                                    

                                                                            </div>
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Osteoarthretic features<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['Osteoarthreticfeatures'][0] ?? '' }}</p>
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        <p class="diagnosis_date top_de"><span
                                                                            ...
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            LABJFA15 > Joint Fluid Analysis Results</h6>
...
<div class="ss_result_box">
    <div class="symp_title ">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    REQNERVECON110 > Peripheral Nerve conduction study</h6>
    </div>
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        @if (isset($ElegibilitySTATUS['HistopathMSKBiopsy']) && !empty($ElegibilitySTATUS['HistopathMSKBiopsy'][0]))
                                                                            ...
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Histopath MSK Biopsy - Findings </h6>

                                                                            </div>
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['HistopathMSKBiopsy'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['HistopathMSKBiopsyNote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['HistopathMSKBiopsy'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['Steroidsinjection'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['SteroidsinjectionNote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['Steroidsinjection'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['HAinjection'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['HAinjectionNote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['HAinjection'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['OzoneIAinjection'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['OzoneIAinjectionNote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['OzoneIAinjection'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['NeurolysisBlock'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['NeurolysisBlockNote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['NeurolysisBlock'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="Add_Diagnosis">
                    ...
                    <input type="hidden" value="KneePain" name="formType"/>
