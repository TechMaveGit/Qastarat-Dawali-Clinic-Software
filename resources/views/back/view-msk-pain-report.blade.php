...
<div class="ss_result_box">
    <div class="symp_title ">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    LABJFA15 > Histopath MSK Biopsy - Findings</h6>
    </div>

    @if (isset($jsonData['LABJFA15']) && $jsonData['LABJFA15'][0]=='Abnormal')
    <p class="ss_result">{{ $jsonData['LABJFA15'][0] ?? '' }}</p>
    <p class="ss_result">
        &nbsp;&nbsp;{{ $jsonData['LABJFA15Note'][0] ?? '' }}</p>
        @else
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['LABJFA15'][0] ?? '' }}</p>
    @endif
                                                                ...
                                                                <div class="read-more-content " style="">
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['NerveBlockinjection'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['NerveBlockinjectionNote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['NerveBlockinjection'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['STE'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['STENote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['STE'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        @if (! isset($ElegibilitySTATUS['Others']) || ! isset($ElegibilitySTATUS['STE'])
                                                                       
                                                                                || ! isset($ElegibilitySTATUS['NerveRFTherapy'])
                                                                                || ! isset($ElegibilitySTATUS['NerveBlockinjection'])
                                                                                || ! isset($ElegibilitySTATUS['NerveBlockinjection'])
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="Add_Diagnosis">
                    ...
                    <input type="hidden" value="MSKPain" name="formType"/>
