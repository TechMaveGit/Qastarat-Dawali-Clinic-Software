                    ...
                    <div class="top_menus top_menu_up">
                        ...
                        <div class="right_mm">
                            ...
                            <div class="view_record_icon">
                                ...
                                <a href="#" class="action_btn_tooltip" onclick="genrate_report('view_pelvic_cong_embo')" >
                                                                ...
                                                                <li>
                                                                    <div class="appoin_title_">
                                                                        <form action="{{ route('user.patient_medical_detail', ['id' => @$id]) }}" method="get">
                                                                            ...
                                                                            <h6>PCE {{ $key + 1 }}  <span class="text-align-right">
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('view_pelvic_cong','diagnosis')" class="bottom_btn extract_btn"
                                                                        >
                                                                    ...
                                                                    <div class="read-more-content " style="">
                                                                        ...
                                                                        <div class="diagnosis_show ">
                                                                            <p class="diagnosis_date"><span
                                                                                    ...
                                                                                    |&nbsp;{{ optional(optional($diagnosis_cid)->doctor)->name ?? '' }}
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                         ...
                                                                         <a onclick="viewDocument('view_pelvic_cong','sympotms')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                        ...
                                        <div id="collapseleft16" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="appointments___list past_medical_history_ak diagnosis_data">
                                                    ...
                                                    @forelse ($document_file as $alldocument_file)
                                                        @if (in_array($alldocument_file->form_section_type, ['sympotms']))
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                         ...
                                                                         <a onclick="viewDocument('view_pelvic_cong','severity_symptoms_scale')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                                            ...
                                                                            <div class="diagnosis_show">
                                                                                ...
                                                                                <div class="ss_result_box">
                                                                                    <div class="symp_title mb-1">
                                                                                        <h6><span class="point_dia"><i
                                                                                                    class="fa-regular fa-circle-dot"></i></span>
                                                                                            Pelvic Congestion Symptoms Scale
                                                                                            (PCSS)</h6>
                                                                                    </div>
                                                                                    @php
                                                                                        $sum = 0;
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                       ...
                                                                       <a onclick="viewDocument('view_pelvic_cong','clinic_exam')" class="bottom_btn extract_btn"
                                                                          >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                    ...
                                    <div id="collapseleft5" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <div class="appointments___list past_medical_history_ak diagnosis_data">
                                                ...
                                                @forelse ($document_file as $alldocument_file)
                                                    @if (in_array($alldocument_file->form_section_type, ['clinic_exam']))
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('view_pelvic_cong','order_imaging_exam')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Dilated pelvic varices
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USGENERAL70Dilatedpelvicvarices'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['USGENERAL70VenousReflux'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['USGENERAL70FreeFluid'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['USGENERAL70SuapiciousPelvicmass'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-3">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    MRCIR48 >MRI - Female Pelvis Protocol-
                                                                                    Findings</h6>
                                                                            </div>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['MRCIR48Dilatedpelvicvarices'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['MRCIR48VenousReflux'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['MRCIR48SuapiciousPelvicmass'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['MRCIR48NetcruckerFeatures'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['CTCIR48Dilatedpelvicvarices'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['CTCIR48VenousReflux'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['CTCIR48SuapiciousPelvicmass'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['CTCIR48NetcruckerFeatures'][0] ?? '' }}
                                                                                </p>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('view_pelvic_cong','order_tab_test')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('view_pelvic_cong','speical_investigation')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                    ...
                                    <div id="collapseleft12" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <div class="appointments___list past_medical_history_ak diagnosis_data">
                                                ...
                                                @forelse ($document_file as $alldocument_file)
                                                    @if (in_array($alldocument_file->form_section_type, ['speical_investigation']))
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('view_pelvic_cong','mbt_review')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('view_pelvic_cong','eligibility_status')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: 'Eligibility Status Added successfully!',
                                                icon: 'success',
                                                showConfirmButton: false, // Hide the default "OK" button
                                                timer: 2000 // Display the message for 2 seconds
                                            }).then(() => {
