            ...
            <div class="row">
              ...
              <span class="toolTip">Enter Vitals</span>
                ...
                <span class="toolTip">Print all notes</span>
                                    ...
                                    <a href="#" class="action_btn_tooltip" onclick="genrate_report('prostate_form')" >
                                                                ...
                                                                <li>
                                                                    <div class="appoin_title_">
                                                                        <form action="{{ route('user.patient_medical_detail', ['id' => @$id]) }}" method="get" target="_blank">
                                                                            ...
                                                                            <h6>Prostate {{ $key + 1 }}  <span class="text-align-right">
                    ...
                    <div class="right_side_mm_box">
                        <div class="card mb-3 form2_bg">
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('prostate_report','diagnosis')" class="bottom_btn extract_btn"
                                                                        >
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('prostate_report','symptoms')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('prostate_report','severity_symtoms_scale')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                   ...
                                                                   <a onclick="viewDocument('prostate_report','clinical_exam')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                   ...
                                                                   <a onclick="viewDocument('prostate_report','order_imageing_exam')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                            ...
                            <!-- USBIOPSYPROSTETE690 / Prostate AdenoCarcinoma  end -->
                                                ...
                                                @forelse ($document_file as $alldocument_file)
                                                    @if (in_array($alldocument_file->form_section_type, ['order_imageing_exam']))
                                                    ...
                                                    <div class="enterd_by">
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                   <a onclick="viewDocument('prostate_report','order_lab_test')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                    ...
                                                    <div class="enterd_by">
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                   <a onclick="viewDocument('prostate_report','order_special_investigation')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                   ...
                                                                   <a onclick="viewDocument('prostate_report','mdt_review')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                   ...
                                                                   <a onclick="viewDocument('prostate_report','eligibility_status')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                            title: 'Success',
                                            text: 'Vital Measurement Added successfully!!',
                                            icon: 'success',
                                            showConfirmButton: false, // This will hide the OK button
                                            timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                        }).then(() => {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                    title: 'Success',
                                                    text: 'Past Medical History Added successfully!',
                                                    icon: 'success',
                                                    showConfirmButton: false, // This will hide the OK button
                                                    timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                                }).then(() => {
