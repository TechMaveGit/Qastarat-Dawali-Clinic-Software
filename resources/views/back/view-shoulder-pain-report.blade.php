                                                                       ...
                                                                       @if (isset($jsonData) && is_array($jsonData) && array_key_exists("Softtissue",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Soft tissue infection (acute pain | acute fever | acute swelling | acute redness)</h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['Softtissue'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("ShoulderProsthesis",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Shoulder Prosthesis</h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['ShoulderProsthesis'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("seroma",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Post-op seroma / spine collection</h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['seroma'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Nerve impegment (Affected nerve)<p>

                                                                                    @if (isset($jsonData['Affectednerve'][0]) && $jsonData['Affectednerve'][0] =='Non-Visible')
                                                                                    <p class="ss_result">{{ $jsonData['Affectednerve'][0] ?? '' }}</p>
                                                                                    <p class="ss_result">
                                                                                        &nbsp;&nbsp;{{ $jsonData['AffectednerveNote'][0] ?? '' }}</p>
                                                                                        @else
                                                                                        <p class="ss_result">
                                                                                            &nbsp;&nbsp;{{ $jsonData['Affectednerve'][0] ?? '' }}</p>
                                                                                    @endif
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Shoulder effusion<p>

                                                                                    @if (isset($jsonData['Shouldereffusion'][0]) && $jsonData['Shouldereffusion'][0] =='Yes')
                                                                                    <p class="ss_result">{{ $jsonData['Shouldereffusion'][0] ?? '' }}</p>
                                                                                    
                                                                                        @else
                                                                                        <p class="ss_result">
                                                                                            &nbsp;&nbsp;{{ $jsonData['Shouldereffusion'][0] ?? '' }}</p>
                                                                                    @endif
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Osteoarthretic features<p>
                                                                                    ...
                                                                                    <p class="ss_result">{{ $jsonData['Osteoarthreticfeatures'][0] ?? '' }}</p>
                                                                ...
                                                                <div class="read-more-content " style="">
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['NerveRFTherapy'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['NerveRFTherapyNote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['NerveRFTherapy'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $ElegibilitySTATUS['ShoulderEmbolization'][0] ?? '' }}</p>
                                                                            <p class="ss_result">
                                                                                &nbsp;&nbsp;{{ $ElegibilitySTATUS['ShoulderEmbolizationNote'][0] ?? '' }}</p>
                                                                                @else
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $ElegibilitySTATUS['ShoulderEmbolization'][0] ?? '' }}</p>
                                                                            @endif
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        @if (! isset($ElegibilitySTATUS['Others']) || ! isset($ElegibilitySTATUS['ShoulderEmbolization'])
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="Add_Diagnosis">
                    ...
                    <input type="hidden" value="ShoulderPain" name="formType"/>
