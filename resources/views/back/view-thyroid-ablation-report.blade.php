                    ...
                    <div class="top_menus top_menu_up">
                        ...
                        <div class="right_mm">
                            ...
                            <div class="view_record_icon">
                                ...
                                <a href="#" class="action_btn_tooltip" onclick="genrate_report('thyroid_form')" >
                            ...
                            <div class="patient_dt_line_mm">
                                ...
                                <div class="accordion acordignleft__small" id="accordionExample2">
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        @php
                                        $patient_allergies = App\Models\patient\Patient_allergy::where('patient_id', decrypt(@$id))->where('form_type','view-thyroid')
                                            ->orderBy('id', 'desc')
                                            ->get();
                                    @endphp
                                                                ...
                                                                @foreach ($patient_past_history as $past_history)
                                                                    <li>
                                                                        ...
                                                                        <div class="appoin_title">
                                                                                ...
                                                                                <p>
                                                                                    {{ \Carbon\Carbon::parse($past_history->created_at)->format('D, d M Y') }}
                                                                                </p>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('thyroid_ablation','diagnosis')" class="bottom_btn extract_btn"
                                                                        >
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('thyroid_ablation','Symptoms')" class="bottom_btn extract_btn"
                                                                            >
                                                                            <i class="fa-solid fa-paperclip"></i> Attach
                                                                        </a>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','Severity_Symptoms_Scale')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="appoin_date">
                                                             ...
                                                             @endforelse
                                                                ...
                                                                <p class="diagnosis_date top_de"><span class="enter_span_hivj"> Entered By | {{ isset($record) ? $record->doctor->name : '' }}</span> <span class="enter_span_hivj">{{ isset($record) && isset($record->created_at) ? $record->created_at->format('D, d M Y, H:i A') : '' }}</span></p> 
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','Clinica_ Exam')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                            ...
                                            <div class="accordion-body">
                                                <div class="appointments___list past_medical_history_ak diagnosis_data">
                                                    <ul>
                                                        ...
                                                        @forelse ($document_file as $alldocument_file)
                                                        @if (in_array($alldocument_file->form_section_type, ['Clinica_']))
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','Order_Imaging_Exam')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                                                          ...
                                                                          <div class="diagnosis_show">
                                                                           <div class="symp_title">
                                                                            <h6><span class="point_dia"><i class="fa-regular fa-circle-dot"></i></span>
                                                                                ...
                                                                                <a href="{{ asset('/assets/thyroid-eligibility-form/' . $VaricoceleEmboForm->AnnotateimageData) }}" target="_blank" class="input-group-text view-image-icon">
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">TR4 (4-6 pts- Moderately Suspicious)</p>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','Order_Lab')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                            ...
                                            <div class="accordion-body">
                                                <div class="appointments___list past_medical_history_ak diagnosis_data">
                                                    <ul>
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        <p class="diagnosis_date top_de"><span
                                                                            ...
                                                                            <p class="ss_result"><strong>T4</strong>
                                                                                ...
                                                                                @if (isset($jsonData['T4'][0]) && $jsonData['T4'][0]=='normal')
                                                                                0.9 to 2.3 ng/dL <span>Normal</span>
                                                                                @elseif ( isset($jsonData['T4'][0]) &&  $jsonData['T4'][0]=='low')
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result"><strong>PTH</strong> -
                                                                                ...
                                                                                @if (isset($jsonData['PTH'][0]) &&  $jsonData['PTH'][0]=='normal')
                                                                                (0.4 - 5.49 mIU/L) <span>Normal</span>
                                                                                @elseif (isset($jsonData['PTH'][0]) && $jsonData['PTH'][0]=='low')
                                                                            ...
                                                                            <p class="ss_result"><strong>Ca+</strong> -
                                                                                @if (isset($jsonData['Ca'][0]) && $jsonData['Ca'][0]=='normal')
                                                                                (0.4 - 5.49 mIU/L) <span>Normal</span>
                                                                                @elseif (isset($jsonData['Ca'][0]) && $jsonData['Ca'][0]=='low')
                                                                                Below 0.4 mIU/L <span>Low</span>
                                                        ...
                                                        @forelse ($document_file as $alldocument_file)
                                                        @if (in_array($alldocument_file->form_section_type, ['Order_Lab']))
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','order_special_investigation')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','mbt_review')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','eligibility_status')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','procedure')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','Supportive_Treatment')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','plans_recommandation')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
                                            ...
                                            <div class="accordion-body">
                                                <div class="appointments___list">
                                                    ...
                                                    <ul>
                                                        ...
                                                        @forelse ($document_file as $alldocument_file)
                                                        @if (in_array($alldocument_file->form_section_type, ['plans_recommandation']))
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                          ...
                                                                          <a onclick="viewDocument('thyroid_ablation','progress_notes')" class="bottom_btn extract_btn"
                                                        >
                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                       </a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="Add_Diagnosis">
                    ...
                    <input type="hidden" value="thyroid_form" name="formType"/>
