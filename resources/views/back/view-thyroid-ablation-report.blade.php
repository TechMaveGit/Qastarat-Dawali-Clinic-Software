                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    Thyroid Compressive symptoms score
                                                                                    (TCSS)</h6>
                                                                            </div>
                                                                            @php
                                                                                $sum = 0;
                                                                       ...
                                                                       @if (isset($jsonData) && is_array($jsonData) && array_key_exists("Palpitations",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    hyper-Toxic symptoms: Palpitations |
                                                                                    Sweating | Anxiety | tremor | weight
                                                                                    loss | hair loss</h6>
                                                                            </div>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    Anti-thyroid meds (e.g. Carbimazole)
                                                                                </h6>
                                                                            </div>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    Hypo-thyroid symptoms: lethargy |
                                                                ...
                                                                <div class="read-more-content " style="">
                                                                    <div class="diagnosis_show">
                                                                        <p class="diagnosis_date "><span
                                                                           ...
                                                                           @if (isset($MDT['TTA']) && $MDT['TTA'][0]=='TTA')
                                                                            <div class="ss_result_box">
                                                                                ...
                                                                                <p class="ss_result"> {{ $MDT['TTANote'][0] ?? ''  }}</p>
                                                                            </div>
                                                                            @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $MDT['TENote'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                    ...
                                                                    @if (isset($MDT['OtherOptions']) && $MDT['OtherOptions'][0]=='Other options')
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result"> {{ $MDT['OtherOptionsNote'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                ...
                                                                <div class="read-more-content " style="">
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result"> {{ $ElegibilitySTATUS['TTANote'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result"> {{ $ElegibilitySTATUS['PTTANote'][0] ?? '' }}</p>
                                                                        </div>
                                                                                @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result"> {{ $ElegibilitySTATUS['TENote'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
