                    ...
                    <div class="top_menus top_menu_up">
                        ...
                        <div class="right_mm">
                            ...
                            <div class="view_record_icon">
                                ...
                                <a href="#" class="action_btn_tooltip" onclick="genrate_report('VaricoceleEmboForm')" >
                                                            ...
                                                            <li>
                                                                <div class="appoin_title_">
                                                                    <form action="{{ route('user.patient_medical_detail', ['id' => @$id]) }}" method="get">
                                                                        ...
                                                                        @csrf
                                                                        <h6>Varicocele Embo {{ $key + 1 }}  <span class="text-align-right">
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('varicoceleEmbo_form','diagnosis')" class="bottom_btn extract_btn"
                                                                        >
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('varicoceleEmbo_form','symptoms')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('varicoceleEmbo_form','severity_symptoms_scale')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                                            ...
                                                                            <div class="diagnosis_show">
                                                                                ...
                                                                                <div class="ss_result_box">
                                                                                    ...
                                                                                    @if (isset($sum) && ($sum >= 0 && $sum <= 5))
                                                                                        <p class="ss_result">Mild LUTS (0-5
                                                                                            pts)</p>
                                                                            ...
                                                                            @forelse ($ClinicalIndicator_db as $record)
                                                                                ...
                                                                                @if (isset($jsonData) && is_array($jsonData) && array_key_exists('Undecendedtesticles', $jsonData))
                                                                                    <div class="ss_result_box">
                                                                                        ...
                                                                                        <p class="ss_result">
                                                                                            {{ $jsonData['Undecendedtesticles'][0] ?? '' }}
                                                                                        </p>
                                                                                    </div>
                                                                                @endif
                                                                                @if (isset($jsonData) && is_array($jsonData) && array_key_exists('Erectiledysfunction', $jsonData))
                                                                                    <div class="ss_result_box">
                                                                                        ...
                                                                                        <p class="ss_result">
                                                                                            {{ $jsonData['Erectiledysfunction'][0] ?? '' }}
                                                                                        </p>
                                                                                    </div>
                                                                                @endif
                                                                                ...
                                                                                @if (isset($jsonData) && is_array($jsonData) && array_key_exists('Secondaryinfertility', $jsonData))
                                                                                    <div class="ss_result_box">
                                                                                        ...
                                                                                        <p class="ss_result">
                                                                                            {{ $jsonData['Secondaryinfertility'][0] ?? '' }}
                                                                                        </p>
                                                                                    </div>
                                                                                @endif
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('varicoceleEmbo_form','clinical_Exam')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('varicoceleEmbo_form','order_Imaging_Exam')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                                     ...
                                                                     <div class="diagnosis_show">
                                                                      <div class="symp_title">
                                                                       <h6><span class="point_dia"><i class="fa-regular fa-circle-dot"></i></span>
                                                                           ...
                                                                           <a href="{{ asset('/assets/thyroid-eligibility-form/' . $viewForm->AnnotateimageData) }}" target="_blank" class="input-group-text view-image-icon">
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    USVENOUSDOPPLER70 &gt; Varicocel Grade -
                                                                                    LEFT</h6>
                                                                            </div>
                                                                            @if (isset($jsonData) && is_array($jsonData) && array_key_exists('LEFTTesticularSize', $jsonData))
                                                                                <div class="symp_title mb-1">
                                                                                    <h6>
                                                                                        Testicular Size / Volume (< 2
                                                                                            cc)</h6>
                                                                                </div>
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['LEFTTesticularSize'][0] ?? '' }}
                                                                                </p>
                                                                            @endif
                                                                            @if (isset($jsonData) && is_array($jsonData) && array_key_exists('LEFTTesticularMass', $jsonData))
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['LEFTTesticularMass'][0] ?? '' }}
                                                                                </p>
                                                                            @endif
                                                                            @if (isset($jsonData) && is_array($jsonData) && array_key_exists('LEFTTesticularCalcification', $jsonData))
                                                                                <div class="symp_title mb-1">
                                                                                    <h6>
                                                                                        Testicular Calcification (Echogenic
                                                                                        foci)</h6>
                                                                                </div>
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['LEFTTesticularCalcification'][0] ?? '' }}
                                                                                </p>
                                                                            @endif
                                                                            @if (isset($jsonData) && is_array($jsonData) && array_key_exists('LEFTEpididemisAbnormality', $jsonData))
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['LEFTEpididemisAbnormality'][0] ?? '' }}
                                                                                </p>
                                                                            @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            @if (isset($jsonData) && is_array($jsonData) && array_key_exists('RIGHTTesticularMass', $jsonData))
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['RIGHTTesticularMass'][0] ?? '' }}
                                                                                </p>
                                                                            @endif
                                                                            @if (isset($jsonData) && is_array($jsonData) && array_key_exists('RIGHTTesticularCalcification', $jsonData))
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['RIGHTTesticularCalcification'][0] ?? '' }}
                                                                                </p>
                                                                            @endif
                                                                            @if (isset($jsonData) && is_array($jsonData) && array_key_exists('RIGHTEpididemisAbnormality', $jsonData))
                                                                                ...
                                                                                <p class="ss_result">
                                                                                    {{ $jsonData['RIGHTEpididemisAbnormality'][0] ?? '' }}
                                                                                </p>
                                                                            @endif
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('varicoceleEmbo_form','order_lab_test')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        @php
                                                                            ...
                                                                            //     die;
                                                                        @endphp
                                                                         @if (isset($jsonData['Prolactin'][0]) ||
                                                                         isset($jsonData['TSH'][0]) ||
                                                                         isset($jsonData['FSH'][0]) ||
                                                                         isset($jsonData['LH'][0]) ||
                                                                         isset($jsonData['Testosterone'][0]) ||
                            ...
                            <div class="accordion-item mm_title">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseleft12" aria-expanded="false"
                                        aria-controls="collapseleft12">
                                        <div class="top_title_mm_box">
                                                    ...
                                                    <div class="right_side_hjkl">
                                                        ...
                                                        <div class="customdotdropdown">
                                                            ...
                                                            <div class="dropdown-content">
                                                                ...
                                                                <a onclick="viewDocument('varicoceleEmbo_form','order_special_investigation')" class="bottom_btn extract_btn"
                                                                >
                                                                 <i class="fa-solid fa-paperclip"></i> Attach
                                                               </a>
                                                            ...
                                                            <div class="appoin_date">
                                                                <div class="read-more-content " style="">
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        @endif
                                                                        @if (!isset($MDT['OtherOptions']) && !isset($MDT['Surgical']) && !isset($MDT['TE']) && !isset($MDT['TTA']) && !isset($MDT['TENote']) && !isset($MDT['UFENote']) && !isset($MDT['MedicalNote']))
                                                                            <div class="ss_result_box">
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: 'Order Special Invistigation Added successfully!',
                                                icon: 'success',
                                                showConfirmButton: false, // This will hide the OK button
                                                timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                            }).then(() => {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: 'MDT Review Added successfully!',
                                                icon: 'success',
                                                showConfirmButton: false, // This will hide the OK button
                                                timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                            }).then(() => {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: 'Order Imaginary Exam Added successfully!',
                                                icon: 'success',
                                                showConfirmButton: false, // This will hide the OK button
                                                timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                            }).then(() => {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: 'Video Call Added successfully!',
                                                icon: 'success',
                                                showConfirmButton: false, // This will hide the OK button
                                                timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                            }).then(() => {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: ' Drug Item Added successfully!',
                                                icon: 'success',
                                                showConfirmButton: false, // This will hide the OK button
                                                timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                            }).then(() => {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: 'Clinical Exam Added successfully!',
                                                icon: 'success',
                                                showConfirmButton: false, // This will hide the OK button
                                                timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                            }).then(() => {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result != '') {
                                    ...
                                    Swal.fire({
                                                title: 'Success',
                                                text: 'Past Surgical History Added successfully!',
                                                icon: 'success',
                                                showConfirmButton: false, // This will hide the OK button
                                                timer: 1000 // Set the timer to reload the page after 1 second (1000 milliseconds)
                                            }).then(() => {
