                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            Varicose Veins Symptoms Score (VVSS)
                                                                                    </h6>
                                                                            </div>
                                                                            @php
                                                                                $sum = 0;
                                                                            ...
                                                                            <p class="ss_result">Mild LUTS (0-15 pts)</p>
                                                                            @elseif (isset($sum) && ($sum >= 16 && $sum <= 39))
                                                                            <p class="ss_result">Moderate LUTS (16-39 pts)</p>
                                                                            @elseif (isset($sum) && ($sum >= 40 && $sum <= 1009))
                                                                            <p class="ss_result">Severe LUTS (40-55 pts)</p>
                                                                            @endif
                                                                       ...
                                                                       @if (isset($jsonData) && is_array($jsonData) && array_key_exists("lowerextremityPhlepitis",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            lower extremity Phlepitis</h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['lowerextremityPhlepitis'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("lowerextremityDVT",$jsonData) )

                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            lower extremity DVT (ACTIVE)</
                                                                                </h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['lowerextremityDVT'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        @if (isset($jsonData) && is_array($jsonData) && array_key_exists("lowerextremityDVTCHRONIC",$jsonData) )
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            lower extremity DVT (CHRONIC)</h6>
                                                                            </div>
                                                                            <p class="ss_result">{{ $jsonData['lowerextremityDVTCHRONIC'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        @php
                                                                            ...
                                                                            //     die;
                                                                        @endphp
                                                                        <!--USVENOUSDOPPLER70  > Great Saphenous Vein (GSV) - LEFT start -->
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-3">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            USVENOUSDOPPLER70  > Great Saphenous Vein (GSV) - LEFT</h6>
                                                                            </div>

                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Dilated<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70DilatedGSVLEFT'][0] ?? '' }}</p>
                                                                                
                                                                                    

                                                                            </div>
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Reflux +<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70RefluxGSVLEFT'][0] ?? '' }}</p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Reflux ++<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux2GSVLEFT'][0] ?? '' }}</p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Reflux +++<p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux3GSVLEFT'][0] ?? '' }}</p>
                                                                                
                                                                                    

                                                                            </div>
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Occlusive / partial thrombosisp>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70OcclusiveGSVLEFT'][0] ?? '' }}</p>
                                                                 ...
                                                                 <!--USVENOUSDOPPLER70  > Great Saphenous Vein (GSV) - LEFT end -->

                                                                 
  <!--USVENOUSDOPPLER70 > Short Saphenous Vein (SSV) - LEFT start -->
  <div class="ss_result_box">
    <div class="symp_title mb-3">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    USVENOUSDOPPLER70 > Short Saphenous Vein (SSV) - LEFT</h6>
    </div>

    <div class="symp_title mb-3">
        <p class="ss_result">Dilated<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70DilatedSSVLEFT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux +<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70RefluxSSVLEFT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux ++<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux2SSVLEFT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux +++<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux3SSVLEFT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Occlusive / partial thrombosisp>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70OcclusiveSSVLEFTSSVLEFT'][0] ?? '' }}</p>
...
<!--USVENOUSDOPPLER70 > Short Saphenous Vein (SSV) - LEFT end -->

<!--USVENOUSDOPPLER70 > Great Saphenous Vein (GSV) - RIGHT start -->
<div class="ss_result_box">
    <div class="symp_title mb-3">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    USVENOUSDOPPLER70 > Great Saphenous Vein (GSV) - RIGHT</h6>
    </div>

    <div class="symp_title mb-3">
        <p class="ss_result">Dilated<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70DilatedGSVRIGHT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux +<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70RefluxGSVRIGHT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux ++<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux2GSVRIGHT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux +++<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux3GSVRIGHT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Occlusive / partial thrombosisp>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70OcclusiveGSVRIGH'][0] ?? '' }}</p>
...
<!--USVENOUSDOPPLER70 > Great Saphenous Vein (GSV) - RIGHT end -->

<!--USVENOUSDOPPLER70 > Short Saphenous Vein (SSV) - RIGHT -->
<div class="ss_result_box">
    <div class="symp_title mb-3">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    USVENOUSDOPPLER70 > Short Saphenous Vein (SSV) - RIGH</h6>
    </div>

    <div class="symp_title mb-3">
        <p class="ss_result">Dilated<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70DilatedSSVRIGHT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux +<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70RefluxSSVRIGHT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux ++<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux2SSVRIGHT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Reflux +++<p>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux3SSVRIGHT'][0] ?? '' }}</p>
    ...
    <div class="symp_title mb-3">
        <p class="ss_result">Occlusive / partial thrombosisp>
        <p class="ss_result">
            &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70OcclusiveSSVRIGHT'][0] ?? '' }}</p>
...
<!--USVENOUSDOPPLER70 > Short Saphenous Vein (SSV) - RIGHT end -->
<!--MRCIR48-->
<div class="ss_result_box">
    <div class="symp_title mb-3">
        <h6><span class="point_dia"><i
                    class="fa-regular fa-circle-dot"></i></span>
                    MRCIR48 > MRI - Lower Extremity Venography Protocol - Findings</h6>
    </div>
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        <p class="diagnosis_date top_de"><span
                                                                            ...
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                            LABABACUTEINFLAME000 > Acute inflammation Results</h6>
                                                                ...
                                                                <div class="read-more-content " style="">
                                                                    <div class="diagnosis_show">
                                                                        <p class="diagnosis_date "><span
                                                                           ...
                                                                           @if (isset($MDT['VVA']) && $MDT['VVA'][0]=='Thermal VVA')
                                                                            <div class="ss_result_box">
                                                                                ...
                                                                                <p class="ss_result"> {{ $MDT['VVANote'][0] ?? ''  }}</p>
                                                                            </div>
                                                                            @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result">{{ $MDT['AblationNote'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                    ...
                                                                    @if (isset($MDT['options']) && $MDT['options'][0]=='options')
                                                                        ...
                                                                        @if (! isset($MDT['options']) || ! isset($MDT['Surgical']) ||  ! isset($MDT['Ablation'])  || ! isset($MDT['VVA']))
                                                                ...
                                                                <div class="read-more-content " style="">
                                                                    <div class="diagnosis_show">
                                                                        <p class="diagnosis_date "><span
                                                                            ...
                                                                            @if (isset($ElegibilitySTATUS['VVThermalAblation']) && $ElegibilitySTATUS['VVThermalAblation'][0]=='VV Thermal Ablation')
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result"> {{ $ElegibilitySTATUS['VVThermalAblationNote'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <p class="ss_result"> {{ $ElegibilitySTATUS['VVNTNTAblationNote'][0] ?? '' }}</p>
                                                                        </div>
                                                                                @endif
                                                                                @if (isset($ElegibilitySTATUS['FoamSclerotherapy']) && $ElegibilitySTATUS['FoamSclerotherapy'][0]=='Foam Sclerotherapy')
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                            ...
                                                                            <p class="ss_result"> {{ $ElegibilitySTATUS['FoamSclerotherapyNote'][0] ?? '' }}</p>
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        @endif
                                                                        @if (! isset($ElegibilitySTATUS['Others']) || ! isset($ElegibilitySTATUS['FoamSclerotherapy']) ||  ! isset($ElegibilitySTATUS['VVNTNTAblation'])  || ! isset($ElegibilitySTATUS['VVThermalAblation']))
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="Add_Diagnosis">
                    ...
                    <input type="hidden" value="VaricoseAblation" name="formType"/>
