                        ...
                        <div class="card mb-3 border_yellow">
                            <div class="card-body p-0">
                                <div class="accordion acordignleft__small" id="accordionExample2">
                                    <div class="accordion-item mm_title">
                                        <h2 class="accordion-header key_diagnosis_accordion">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseleft24" aria-expanded="false" aria-controls="collapseleft24" fdprocessedid="u4x1b2">
                                                <div class="top_title_mm_box ">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="diagnosis_type">
                                                    <h6><span class="point_dia"><i
                                                        ...
                                                        Gernal diagnosis</h6>
                                                        @php
                                                        $diagnosis_general_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'diagnosis_general', 'patient_id' => decrypt(@$id)])
                                                            ->get()
                                                ...
                                                <div class="diagnosis_type">
                                                    <h6><span class="point_dia"><i
                                                                class="fa-regular fa-circle-dot"></i></span> ICD 10</h6>
                                                    @php
                                                        $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'diagnosis_cid', 'patient_id' => decrypt(@$id)])
                                                            ->get()
                                                            ->groupBy(['title_name', 'data_value']);
                                                    @endphp
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        <div id="collapseleft16" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                              @php
                                              $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'symptoms_score', 'patient_id' => decrypt(@$id)])
                                                  ->get()
                                                  ->groupBy(['title_name', 'data_value']);
                                          @endphp
                                        ...
                                        <div id="collapseleft2" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="prescription_btn_mm_box">
                                                    ...
                                                    @php
                                                    $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'referral', 'patient_id' => decrypt(@$id)])
                                                        ->get()
                                                        ->groupBy(['title_name', 'data_value']);
                                                @endphp
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        <div id="collapseleft5" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                              @php
                                              $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'ClinicalIndicator', 'patient_id' => decrypt(@$id)])
                                                  ->get()
                                                  ->groupBy(['title_name', 'data_value']);
                                          @endphp
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        <div id="collapseleft15" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="appointments___list">
                                                  @php
                                                  $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'Imaging', 'patient_id' => decrypt(@$id)])
                                                      ->get()
                                                      ->groupBy(['title_name', 'data_value']);
                                              @endphp
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        <div id="collapseleft17" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="appointments___list">
                                                  @php
                                                  $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'lab', 'patient_id' => decrypt(@$id)])
                                                      ->get()
                                                      ->groupBy(['title_name', 'data_value']);
                                              @endphp
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        <div id="collapseleft12" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                              @php
                                              $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'intervention_procedure', 'patient_id' => decrypt(@$id)])
                                                  ->get()
                                                  ->groupBy(['title_name', 'data_value']);
                                          @endphp
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        <div id="collapseleft18" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                              @php
                                              $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'mdt', 'patient_id' => decrypt(@$id)])
                                                  ->get()
                                                  ->groupBy(['title_name', 'data_value']);
                                          @endphp
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        <div id="collapseleft19" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                              @php
                                              $diagnosis_cid_data = App\Models\patient\VaricoseAblationDiagnosis::where(['title_name' => 'elegibility_status', 'patient_id' => decrypt(@$id)])
                                                  ->get()
                                                  ->groupBy(['title_name', 'data_value']);
                                          @endphp
