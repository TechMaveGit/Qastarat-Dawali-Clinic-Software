            ...
            <div class="row">
              ...
              <span class="toolTip">Enter Vitals</span>
                ...
                <span class="toolTip">Consent Forms</span>
                                ...
                                <!-- <a href="#" class="action_btn_tooltip" data-bs-toggle="offcanvas" data-bs-target="" aria-controls="offcanvasBottom">
                ...
                <span class="toolTip">Print all notes</span>
                                        ...
                                        <a href="#" class="action_btn_tooltip" onclick="genrate_report('VaricoseAblation')" >
                                ...
                                <div class="accordion acordignleft__small" id="accordionExample2">
                                    ...
                                    <div class="accordion-item mm_title">
                                        ...
                                        <div id="collapseleft7" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                @if (count($patient_allergies)>0)
                                                 <ul class="symptoms scroll_list">
                                        ...
                                        <div id="collapseleft3" class="accordion-collapse collapse"
                                            ...
                                            @if (count($patient_past_history)>0)
                                             <div class="accordion-body">
                                                ...
                                                <div class="appointments___list past_medical_history_ak">
                                                        <ul id="past_medical_histories" class="scroll_list">
                                ...
                                <div class="accordion acordignleft__small" id="accordionExample2">
                                    <div class="accordion-item mm_title">
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <a onclick="viewDocument('VaricoseAblation','diagnosis')" class="bottom_btn extract_btn"
                                                                        >
                                        ...
                                        <div id="collapseleft24" class="accordion-collapse collapse show"
                                            ...
                                            @if (count($diagnosis_generals)>0 || count($document_file)>0)
                                            <div class="accordion-body ">
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                       ...
                                                                       <a onclick="viewDocument('VaricoseAblation','symtoms')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                        ...
                                        <div id="collapseleft16" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="appointments___list past_medical_history_ak diagnosis_data">
                                                    ...
                                                    @forelse ($document_file as $alldocument_file)
                                                        @if (in_array($alldocument_file->form_section_type, ['symtoms']))
                                                            ...
                                                            <div class="right_side_hjkl">
                                                                ...
                                                                <div class="customdotdropdown">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                       ...
                                                                       <a onclick="viewDocument('VaricoseAblation','severity_symtoms_scale')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                        ...
                                        <div id="collapseleft2" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                                            ...
                                                                            @forelse ($ClinicalIndicator_db as $record)
                                                                                ...
                                                                                @if (isset($jsonData) && is_array($jsonData) && array_key_exists('lowerextremityPhlepitis', $jsonData))
                                                                                    <div class="ss_result_box">
                                                                                        <div class="symp_title mb-1">
                                                                                            <h6><span class="point_dia"><i
                                                                                                        class="fa-regular fa-circle-dot"></i></span>
                                                                                                lower extremity Phlepitis
                                                                                            </h6>
                                                                                        </div>
                                                                                        <p class="ss_result">
                                                                                            {{ $jsonData['lowerextremityPhlepitis'][0] ?? '' }}
                                                                                        </p>
                                                                                    </div>
                                                                                @endif
                                                                                ...
                                                                                @if (isset($jsonData) && is_array($jsonData) && array_key_exists('lowerextremityDVTCHRONIC', $jsonData))
                                                                                    <div class="ss_result_box">
                                                                                        ...
                                                                                        <p class="ss_result">
                                                                                            {{ $jsonData['lowerextremityDVTCHRONIC'][0] ?? '' }}
                                                                                        </p>
                                                                                    </div>
                                                                                @endif
                                                ...
                                                @endif
                                                    ...
                                                    @forelse ($document_file as $alldocument_file)
                                                        @if (in_array($alldocument_file->form_section_type, ['severity_symtoms_scale']))
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','clinical_exam')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','order_imaging_exam')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="appoin_date">
                                                            ...
                                                            <div class="diagnosis_show">
                                                                ...
                                                                @if (isset($viewImage->AnnotateimageData))
                                                                <div class="appoin_date">
                                                                    <div>
                                                                      <div class="diagnosis_show">
                                                                       <div class="symp_title">
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-3">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    USVENOUSDOPPLER70 > Great Saphenous Vein
                                                                                    (GSV) - LEFT</h6>
                                                                            </div>

                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Dilated
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp; {{ $jsonData['USVENOUSDOPPLER70DilatedGSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Reflux +
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70RefluxGSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux2GSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux3GSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Occlusive / partial
                                                                                    thrombosisp>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70OcclusiveGSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-3">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    USVENOUSDOPPLER70 > Short Saphenous Vein
                                                                                    (SSV) - LEFT</h6>
                                                                            </div>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70DilatedSSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70RefluxSSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux2SSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux3SSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Occlusive / partial
                                                                                    thrombosisp>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70OcclusiveSSVLEFTSSVLEFT'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70DilatedGSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70RefluxGSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux2GSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux3GSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Occlusive / partial
                                                                                    thrombosisp>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70OcclusiveGSVRIGH'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70DilatedSSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70RefluxSSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux2SSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                ...
                                                                                <p>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70Reflux3SSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                            ...
                                                                            <div class="symp_title mb-3">
                                                                                <p class="ss_result">Occlusive / partial
                                                                                    thrombosisp>
                                                                                <p class="ss_result">
                                                                                    &nbsp;&nbsp;{{ $jsonData['USVENOUSDOPPLER70OcclusiveSSVRIGHT'][0] ?? '' }}
                                                                                </p>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-3">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    MRCIR48 > MRI - Lower Extremity
                                                                                    Venography Protocol - Findings</h6>
                                                                            </div>
                                                                        ...
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-3">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    CTCIR48 > CT - Pelvic Venography
                                                                                    Protocol - Findings</h6>
                                                                            </div>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','order_lab_test')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                                ...
                                                                <div class="read-more-content sypm_tom_cnt"
                                                                    ...
                                                                    <div class="diagnosis_show">
                                                                        ...
                                                                        @php
                                                                            ...
                                                                            //     die;
                                                                        @endphp
                                                                        @if(isset($jsonData['ESR'][0]) || isset($jsonData['CRP'][0]))
                                                                        <div class="ss_result_box">
                                                                            <div class="symp_title mb-1">
                                                                                <h6><span class="point_dia"><i
                                                                                            class="fa-regular fa-circle-dot"></i></span>
                                                                                    LABABACUTEINFLAME000 > Acute
                                                                                    inflammation Results</h6>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','order_special_investigation')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','mdt_review')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                    ...
                                    <div id="collapseleft18" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <div class="appointments___list past_medical_history_ak diagnosis_data">
                                                ...
                                                @forelse ($document_file as $alldocument_file)
                                                    @if (in_array($alldocument_file->form_section_type, ['mdt_review']))
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','eligibility_status')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                                        ...
                                                                        <div class="diagnosis_show">
                                                                            ...
                                                                            @if (
                                                                                !isset($ElegibilitySTATUS['Others']) &&
                                                                                    ...
                                                                                    !isset($ElegibilitySTATUS['VVThermalAblation']))
                                                                                <div class="ss_result_box">
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','procedure')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','supportive_treatment')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                                        ...
                                                        @forelse ($supportiveTreatments  as $record)
                                                            <li>
                                                                ...
                                                                <div class="appoin_date">
                                                                    ...
                                                                    {{-- <button class="btn btn_read read-more-btn past_history_readmorebtn"
                                                                        onclick="toggleReadMore(this)">Read More</button> --}} @if(isset($isEditAllowed) && $isEditAllowed)
                                                                        <div class="Bottom_btn">
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','plan_recommandation')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                    ...
                                    <div id="collapseleft9" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <div class="appointments___list">
                                                ...
                                                @forelse ($document_file as $alldocument_file)
                                                    @if (in_array($alldocument_file->form_section_type, ['plan_recommandation']))
                                                        ...
                                                        <div class="right_side_hjkl">
                                                            ...
                                                            <div class="customdotdropdown">
                                                                ...
                                                                <div class="dropdown-content">
                                                                    ...
                                                                    <a onclick="viewDocument('VaricoseAblation','prgress_notes')" class="bottom_btn extract_btn"
                                                                        >
                                                                         <i class="fa-solid fa-paperclip"></i> Attach
                                                                       </a>
                                        ...
                                        <div class="accordion-body">
                                            <div class="appointments___list">
                                                ...
                                                <ul>
                                                    ...
                                                    @forelse ($document_file as $alldocument_file)
                                                    @if (in_array($alldocument_file->form_section_type, ['prgress_notes']))
                ...
                $.ajax({
                    ...
                    success: function(response) 
                    {
                        ...
                        if (response && response.patient_current_med && response.patient_current_med.length > 0) {
                            ...
                            patientData.html('<tr><td colspan="8">No Drug Item found.</td></tr>');
                        }
                    },
                            error: function(xhr, status, error) {
                                console.error('Error fetching data:', error);
