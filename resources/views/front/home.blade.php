...
<div id="statistic-1" class="statistic-section division">
    ...
    <!-- tooltip hide show js -->

    <!-- <script>
        function showTooltip(circleId) {
            var tooltip = document.querySelector("#" + circleId + " .CircleTooltip");
            var tooltipContent = document.querySelector("#" + circleId + " .CircleTooltipContent");
            tooltip.style.display = "block";
            tooltipContent.style.display = "block";
        }

        function closeTooltip(circleId) {
            var tooltip = document.querySelector("#" + circleId + " .CircleTooltip");
            var tooltipContent = document.querySelector("#" + circleId + " .CircleTooltipContent");
        ...
        circles.forEach(circle => {
            ...
            circle.addEventListener('mouseleave', function() {
                closeTooltip(this.id);
                this.classList.remove('ColorActive');
            });
        });
    </script> -->
	...
	$(document).ready(function() {
		...
		function StaffvalidateForm() {
			...
			if (email === '') {
				...
				$('#staffemailError').text('Email  is required');
				$('input[name="staffemail"]').addClass('error');
			}
			...
			if (password === '') {
				...
				$('#staffpasswordError').text('Password  is required');
				$('input[name="staffpassword"]').addClass('error');
			}
