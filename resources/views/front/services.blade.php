...
<body>
 ...
 <li aria-haspopup="true"><a href="#reviews-2">Testimonials</a></li>
                                    ...
                                    <li class="nl-simple {{  request()->routeIs('patient.service') ? 'active': '' }}"
                                        aria-haspopup="true"><a href="{{ route('patient.service') }}"
           ...
           <div class="row d-flex ">
              ...
              <!-- <div class="hero-15-txt wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                         ...
                         <div class="ContentLoginbanner">
                             <h2 class="bnr_title">Online Consultation</h2>
                       <div class="mkdf-breadcrumbs-holder"> <div class="mkdf-breadcrumbs"><div class="mkdf-breadcrumbs-inner"><a href="https://mediclinic.qodeinteractive.com/">Home</a><span class="mkdf-delimiter">&nbsp; / &nbsp;</span><span class="mkdf-current">Our Services</span></div></div></div>
     ...
     <section class="Services_container">
        <div class="container">
           <div class="row">
              ...
              <div class="Service_detailBox serviceitem1">
                    ...
                    <div class="col-lg-6">
                       <div class="service-content-inner">
                          <div class="service-content-wrapper">
                             <h4 class="iq-title iq-heading-title">Fast Track Your Online Consultation </h4>
     
                             <p class="iq-service-desc">Online Consultation is designed to Fast Track your Access
                                to our services if you don’t want to wait</p>
                             <ul class="appoinmentsDays_list">
                                <li>Urgent within 24 hours --- <span>450 USD</span></li>
                                <li>Regular with 7 days ---- <span>250 USD</span></li>
                                <li>Regular (Any time first available slot) ---- <span>150 USD</span></li>
                             </ul>
                             ...
                             <ol class="payment_list">
                                <li>
                                   <div class="iconpoints">1</div>
                                   <span> Obtain a log in via our call center (FREE)</span>
                                </li>
                                <li>
                                   <div class="iconpoints">2</div> <span>Log in and Pay your on-line Consultation fees</span>
                                </li>
                                <li>
                                   <div class="iconpoints">3</div> <span>Choose you on-line (audio, video, or both)
                                      consultation from available slots</span>
                                </li>
                                <li>
                                   <div class="iconpoints">4</div> <span>Attend the remote consultation (audio, video, or
                                      both) according to your
                                      choice</span>
                                </li>
                             </ol>
     ...
     <div class="service-content-image">
                    ...
                    <div class="container-fluid">
                       <div class="row">
                          ...
                          <div class="col-lg-6">
                          <div class="service-content-inner contentdarkbg">
                       <div class="service-content-wrapper">
                          <h4 class="iq-title iq-heading-title">Get copy of Your Medical Report Online </h4>
     
                          <p class="iq-service-desc">For pre-registered patients, You can now print your
                             update report on-line via your portal log-in</p>
                          <ul class="appoinmentsDays_list">
                             <li>Standard Medical Report (without images)-- <span>40 USD</span></li>
                             <li>Standard Medical Report (with images)-- <span>48 USD</span></li>
                             <!-- <li>Regular (Any time first available slot) ---- <span>150 USD</span></li> -->
                          </ul>
                          <h6 class="pay_title">You may also pay in your local currency at check out</h6>
                          <p class="para_consul">Steps to get electronic medical report: </p>
                          ...
                          <ol class="payment_list">
                                ...
                                <li>
                                   <div class="iconpoints">2</div> <span>Log in and Pay report generation fees</span>
                                </li>
                                <li>
                                   <div class="iconpoints">3</div> <span>Download “un-limited: copies any time</span>
                                </li>
     ...
     <section class="Services_container">
        <div class="container">
           <div class="row">
              <div class="Service_detailBox serviceitem3">
                 <div class="service-content row">
                   <div class="col-lg-6">
                   <div class="service-content-image">
                   ...
                   <div class="service-content-inner">
                       <div class="service-content-wrapper">
                          <h4 class="iq-title iq-heading-title">Book in-clinic Consultation </h4>
     
                          <p class="iq-service-desc">In clinic Consultation booked here are eligible for
                             special discount</p>
                          <ul class="appoinmentsDays_list">
                             <li>Get Urgent appointment within 5-7 days ---- <span> 45 OMR (original
                                   consultation fee 55 OMR)</span></li>
                             <li>Get Regular appointment within 15-21 days-- <span>40 OMR (original
                                   consultation fee 55 OMR)</span></li>
                             <!-- <li>Regular (Any time first available slot) ---- <span>150 USD</span></li> -->
                          </ul>
                          <h6 class="pay_title">You may also pay in your local currency at check out</h6>
                          ...
                          <ol class="payment_list">
                                ...
                                <li>
                                   <div class="iconpoints">2</div> <span>Log in and Pay your in-clinic Consultation fees</span>
                                </li>
                                <li>
                                   <div class="iconpoints">3</div> <span>Choose your in-clinic consultation date / time from available slots</span>
                                </li>
                                <li>
                                   <div class="iconpoints">4</div> <span>Receive confirmation via your registered WhatsApp and/or your registered
                                email</span>
                                </li>
                             </ol>
