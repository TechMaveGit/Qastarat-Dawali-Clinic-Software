...
========================= -->
    ...
    <link id="color-switcher" type="text/css" rel="stylesheet"
        href="{{ asset('/assets/images/newChange/color-teal.css') }}" />
                        ...
                        <div class="row g-0">
                            <div class="col-md-8 mx-auto">
                                ...
                                <div class="logo mt-5 mb-5 mx-auto"> <a class="d-flex" href="#" title="Oxyy">
                                        <img src="{{ asset('/assets/images/newChange/img/qastara-logo-new.png') }}"
                                            alt="Oxyy"></a> </div>
                            </div>
                        </div>
                        <div class="row g-0">
                            <div class="col-11 col-md-10 col-lg-9 col-xl-8 mx-auto">
                                        ...
                                        <div class="form__tab active">
                                            <fieldset class="form__group">
                                                <label class="form__label" for="refinance">
                                                    <input class="form__input" type="radio" name="loanType"
                                                        id="refinance" onclick="checkform('1')" checked>
                                                    <span class="form__label-name">IR Staff Login</span>
                                                    <svg class="form__label-check" viewBox="0 0 512 512" width="100"
                                                        title="check-circle">
                                                        <path
                                                ...
                                                <label class="form__label">
                                                    <input class="form__input" required type="radio" name="loanType"
                                                        onclick="checkform('2')" id="purchase">
                                                    <span class="form__label-name">Patient Login</span>
                                                    <svg class="form__label-check" viewBox="0 0 512 512"
                                                        title="check-circle">
                                                        <path
                                                            d="M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z" />
                                                    </svg>
                                ...
                                <form class="form_container loginFormcontainer" id="patientLoginForm" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="email" class="form-control mt-3" name="email" id="emailAddress"
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input id="password-field" type="password" class="form-control mb-2"
                                                    name="password" placeholder="Password">
                                                <iconify-icon id="toggle-icon" class="field-icon"
                                                    icon="ph:eye"></iconify-icon>
                                            </div>
                                        </div>
                                ...
                                <div class="row g-0 my-auto">
                                    <div class="col-12 col-md-12 col-lg-12 mx-auto">
                                        <div class="right_img position-relative">
                                            <img src="{{ asset('/assets/images/newChange/img/Health professional team-bro (1).png') }}"
                                                alt="">
                                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            if (result.error == 200) {
                              ...
                              Swal.fire({
                                    title: 'Login Failed !', // Empty title
                                    text: result.error, // Success message
                                    icon: 'warning',
