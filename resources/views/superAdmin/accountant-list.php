...
<div class="box">
   <div class="box-header with-border">
    ...
    <a href="accountant-add.php" class="waves-effect waves-light btn btn-md btn-primary"><i class="fa-solid fa-plus"></i> Add Accountant</a>
    </div>
           ...
           <tbody>
               <tr>
                   ...
                   <div class="btn-group">
                        ...
                        <a class="dropdown-item" href="accountant-edit.php">Edit</a>
