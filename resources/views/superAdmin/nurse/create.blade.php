                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="NursingSchool"
                                                    value="{{ old('NursingSchool') }}" class="form-control"
                                                    placeholder="">
                                                @error('NursingSchool')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <!-- @php
                                            $doctors = \App\Models\superAdmin\Doctor::where(
                                                'user_type',
                                                'doctor',
                                            )->get();
                                        @endphp
