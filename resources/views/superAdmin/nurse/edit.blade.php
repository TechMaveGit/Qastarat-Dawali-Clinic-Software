              ...
              <div class="box-body">
                  ...
                  @enderror
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{ $nurse->post_code }}" class="form-control" placeholder="" name="post_code">
                          @error('post_code')
                          <span class="error text-danger">{{ $message }}</span>
                      @enderror
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{ $nurse->mobile_no }}" class="form-control" placeholder="" name="mobile_no">
                          @error('mobile_no')
                          <span class="error text-danger">{{ $message }}</span>
                      @enderror
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{ $nurse->specialty }}" class="form-control" placeholder="" name="specialty">
                          @error('specialty')
                          <span class="error text-danger">{{ $message }}</span>
                      @enderror
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{ $nurse->qualifications }}" class="form-control" placeholder="" name="qualifications">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{ $nurse->experience }}" class="form-control" placeholder="" name="experience">
                          @error('experience')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{ $nurse->working_hours }}" class="form-control" placeholder="" name="working_hours">
                          @error('working_hours')
                          <span class="error text-danger">{{ $message }}</span>
                      @enderror
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{ $nurse->languages_spoken }}" class="form-control" placeholder="" name="languages_spoken">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{ $nurse->lincense_no }}" class="form-control" placeholder="" name="lincense_no">
                          @error('lincense_no')
                          <span class="error text-danger">{{ $message }}</span>
                      @enderror
                      </div>
