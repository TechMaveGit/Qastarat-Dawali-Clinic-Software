        ...
        <div class="container-full">
            ...
            <section class="content">
                <div class="row">
                    ...
                    <form action="{{ route('nurses.edit', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" style="width: 100%;" name="title">
                                                    ...
                                                    <option value="Mr"
                                                        {{ $nurse->title == 'Mr' ? 'selected="selected"' : '' }}>Mr
                                                    </option>
                                                    <option value="Mrs"
                                                        {{ $nurse->title == 'Mrs' ? 'selected="selected"' : '' }}>Mrs
                                                    </option>
                                                    <option value="Miss"
                                                        {{ $nurse->title == 'Miss' ? 'selected="selected"' : '' }}>Miss
                                                    </option>
                                                    <option value="Ms"
                                                        {{ $nurse->title == 'Ms' ? 'selected="selected"' : '' }}>Ms</option>
                                                    <option value="Dr"
                                                        {{ $nurse->title == 'Dr' ? 'selected="selected"' : '' }}>Dr
                                                    </option>
                                                    <option value="Lady"
                                                        {{ $nurse->title == 'Lady' ? 'selected="selected"' : '' }}>Lady
                                                    </option>
                                                    <option value="Sir"
                                                        {{ $nurse->title == 'Sir' ? 'selected="selected"' : '' }}>Sir
                                                    </option>
                                                    <option value="Professor"
                                                        {{ $nurse->title == 'Professor' ? 'selected="selected"' : '' }}>
                                                        Professor</option>
                                                    <option value="Capt"
                                                        {{ $nurse->title == 'Capt' ? 'selected="selected"' : '' }}>Capt
                                                    </option>
                                                    <option value="Lord"
                                                        {{ $nurse->title == 'Lord' ? 'selected="selected"' : '' }}>Lord
                                                    </option>
                                                </select>
                                                @error('title')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" value="{{ $nurse->birth_date }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="gendar" style="width: 100%;">
                                                    <option value="male"
                                                        {{ $nurse->gendar == 'male' ? 'selected' : '' }}>Male</option>
                                                    <option value="female"
                                                        {{ $nurse->gendar == 'female' ? 'selected' : '' }}>Female</option>
                                                    <option value="   "
                                                        {{ $nurse->gendar == 'other' ? 'selected' : '' }}>Other</option>
                                                </select>
                                                @error('gendar')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="role_id" style="width: 100%;">
                                                    @foreach ($roleData as $addRoleData)
                                                        <option value="{{ $addRoleData->id }}"
                                                            {{ $addRoleData->id == $nurse->role_id ? 'selected' : '' }}>
                                                            {{ $addRoleData->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('role_id')
                                                    <span class="error text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="status" style="width: 100%;">
                                                    ...
                                                    <option value="active"
                                                        {{ $nurse->status == 'active' ? 'selected' : '' }}>Active</option>
                                                    <option value="inactive"
                                                        {{ $nurse->status == 'inactive' ? 'selected' : '' }}>Inactive
                                                    </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $nurse->email }}" class="form-control"
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $nurse->mobile_no }}"
                                                    class="form-control" placeholder="" name="mobile_no" minlength="10"
                                                    maxlength="15">
                                                @error('mobile_no')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $nurse->landline }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $nurse->post_code }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $nurse->street }}" class="form-control"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $nurse->town }}" class="form-control"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="NursingSchool"
                                                    value="{{ $nurse->NursingSchool }}" class="form-control"
                                                    placeholder="">
                                                @error('NursingSchool')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Degree" value="{{ $nurse->Degree }}"
                                                    class="form-control" placeholder="">
                                                @error('Degree')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="graduation_year"
                                                    value="{{ $nurse->graduation_year }}" class="form-control"
                                                    placeholder="">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="lincense_no"
                                                    value="{{ $nurse->lincense_no }}" class="form-control"
                                                    placeholder="">
                                                @error('lincense_no')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="experience"
                                                    value="{{ $nurse->experience }}"class="form-control" placeholder="">
                                                @error('experience')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="dropify"
                                                    data-default-file="{{ asset('/assets/nurse_profile/' . $nurse->patient_profile_img) }}"
                                                    name="patient_profile_img" accept="image/*" />
                                            </div>
                                        </div>
