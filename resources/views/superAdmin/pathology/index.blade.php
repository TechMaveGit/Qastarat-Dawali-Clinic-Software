    ...
    <div class="content-wrapper">
        <div class="container-full">
            ...
            <div class="content-header edit_title_head mb-0">
                <div class="d-flex">
                    <h4 class="page-title lab_name">All Pathology</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Pathology Department</a></li>
                            <li class="breadcrumb-item active" aria-current="page">All Pathology</li>
                        </ol>
                    </nav>
                </div>
                            ...
                            <div class="box-header with-border">
                                <div class="top_area">
                                    ...
                                    <a onclick="openForm()" class="waves-effect waves-light btn btn-md btn-primary"><i
                                            class="fa-solid fa-plus"></i> Add New Pathology</a>
                                </div>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                                ...
                                                <tbody>
                                                    @foreach ($pathologys as $key => $allpathologys)
                                                        <tr>
                                                            ...
                                                            <td>{{ $allpathologys->email_address }}</td>
                                                            <td>{{ $allpathologys->mobile_phone }}</td>
                                                            <td>{{ $allpathologys->landline }}</td>
                                                            <td>{{ $allpathologys->street }}</td>
                                                            <td>
                                                                <ul class="action_icons">
                                                                    <li>
                                                                        <a onclick="editForm('{{ $allpathologys->id }}','{{ $allpathologys->lab_name }}','{{ $allpathologys->email_address }}','{{ $allpathologys->mobile_phone }}','{{ $allpathologys->landline }}','{{ $allpathologys->post_code }}','{{ $allpathologys->street }}','{{ $allpathologys->town }}')"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="landline" id="landline" class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Post Code</label>
                                <input type="text" name="post_code" id="post_code" class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
