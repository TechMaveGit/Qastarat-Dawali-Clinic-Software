...
<div class="box">
   <div class="box-header with-border">
    ...
    <a href="nurse-add.php" class="waves-effect waves-light btn btn-md btn-primary"><i class="fa-solid fa-plus"></i> Add Nurse</a>
    </div>
           ...
           <tbody>
               <tr>
                   ...
                   <div class="btn-group">
                        ...
                        <a class="dropdown-item" href="nurse-edit.php">Edit</a>
