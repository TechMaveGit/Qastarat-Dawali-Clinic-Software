    ...
    <div class="content-wrapper">
        <div class="container-full">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('telecallers.create') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input value="{{ old('birth_date') }}" type="text"
                                                        class="form-control pull-right datepicker" name="birth_date">
                                                    @error('birth_date')
                                                        <span class="error text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-label">Mobile Phone<span
                                                        class="clr">*</span></label>
                                                <input type="text" class="form-control" placeholder=""
                                                    name="mobile_no" value="{{ old('mobile_no') }}" minlength="10"
                                                    maxlength="15">
                                                @error('mobile_no')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    name="post_code" value="{{ old('post_code') }}" minlength="4"
                                                    maxlength="8">
                                                @error('post_code')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    name="soft_skill" value="{{ old('soft_skill') }}">
                                                @error('soft_skill')
                                                    <span class="error text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" style="width: 100%;"
                                                    ...
                                                    <option value="Good"
                                                        {{ old('communication_skill') == 'Good' ? 'selected' : '' }}>Good
                                                    </option>
                                                    <option value="Very Good"
                                                        {{ old('communication_skill') == 'Very Good' ? 'selected' : '' }}>
                                                        Very Good</option>
                                                    <option value="Excellent"
                                                        {{ old('communication_skill') == 'Excellent' ? 'selected' : '' }}>
                                                        Excellent</option>
