...
<head>
    ...
    <link rel="icon" href="images/newimages/iconlogo.png">

    <title>QASTARAT & DAWALI CLINICS</title>
  ...
  <header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">	
		...
		<a href="index.html" class="logo">
		  <!-- logo-->
		  <div class="logo-mini">
			  <span class="light-logo LogoFull_width"><img src="images/newimages/logo.png" alt="logo"></span>
			  <span class="light-logo logowIcon"><img src="images/newimages/iconlogo.png" alt="logo"></span>
		  ...
		  <div class="multinav-scroll" style="height: 100%;">	
			  ...
			  <ul class="sidebar-menu" data-widget="tree">			
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					<li><a href="nurse-list.php"><i class="fa-solid fa-minus"></i>Nurse</a></li>
					<li><a href="accountant-list.php"><i class="fa-solid fa-minus"></i>Accountant</a></li>
					<li><a href="telecaller-list.php"><i class="fa-solid fa-minus"></i>Telecaller</a></li>
				  </ul>
				</li>
				<li class="treeview">
