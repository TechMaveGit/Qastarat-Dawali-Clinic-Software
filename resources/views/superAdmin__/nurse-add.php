					  ...
					  <!-- /.form-group -->
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="(e.g., RN, BSN, MSN)">
                        </div>
                        </div>
                        <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="submit_btn text-end">
                                <a href="nurse-list.php"><button type="button" class="waves-effect waves-light btn btn-primary"><i class="fa-regular fa-floppy-disk"></i> Save</button></a>
                            </div>
                        </div>
                    </div>
                  </div>
