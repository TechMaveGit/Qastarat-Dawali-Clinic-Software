                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <ul class="action_icons">
                                                                    <li>
                                                                        <a onclick="editForm('{{ $allpathologys->id }}','{{ $allpathologys->lab_name }}','{{ $allpathologys->email }}','{{ $allpathologys->mobile_no }}','{{ $allpathologys->landline }}','{{ $allpathologys->post_code }}','{{ $allpathologys->street }}','{{ $allpathologys->town }}')"
