...
<div class="box">
   <div class="box-header with-border">
    ...
    <a href="patient-add.php" class="waves-effect waves-light btn btn-md btn-primary"><i class="fa-solid fa-plus"></i> Add Patient</a>
    </div>
               ...
               <tr>
                   ...
                   <td>
                     <div class="btn-group">
                        ...
                        <a class="dropdown-item" href="patient-edit.php">Edit</a>
