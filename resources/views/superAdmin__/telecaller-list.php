...
<div class="box">
   <div class="box-header with-border">
    ...
    <a href="telecaller-add.php" class="waves-effect waves-light btn btn-md btn-primary"><i class="fa-solid fa-plus"></i> Add Telecaller</a>
    </div>
               ...
               <tr>
                   ...
                   <td>
                     <div class="btn-group">
                        ...
                        <a class="dropdown-item" href="telecaller-edit.php">Edit</a>
